...
class DownloaderUtilTest {
    ...
    @Test
    fun `guessFileName - null content disposition and imagejpeg content type - correct filename extracted`() {
        assertEquals(
    ...
    @Test
    fun `fileNameFromContentDisposition - content disposition with inline and filename star encoded and filename`() {
        assertEquals(
            "中文文件名测试.txt",
            DownloaderUtil.fileNameFromContentDisposition(
                """
