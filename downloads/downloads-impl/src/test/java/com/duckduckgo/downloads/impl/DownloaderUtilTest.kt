...
class DownloaderUtilTest {
    ...
    @Test
    fun `guessFileName - null content disposition and image·jpeg content type and unsupported chars in filename - correct filename extracted`() {
        assertEquals(
    ...
    @Test
    fun `guessFileName - inline content disposition and application·pdf - correct filename extracted`() {
        assertEquals(
    ...
    @Test
    fun `guessFileName - empty content disposition and application·pdf content type - correct filename extracted`() {
        assertEquals(
    ...
    @Test
    fun `guessFileName - empty content disposition and correct file extension in URL - correct filename extracted`() {
        assertEquals(
            "93348617.pkpass",
            DownloaderUtil.guessFileName(
                url = """
    ...
    @Test
    fun `guessFileName - empty content disposition and text·x-python3 content type and correct file extension in URL - correct filename extracted`() {
        assertEquals(
            "bat.py",
            DownloaderUtil.guessFileName(
                url = """
    ...
    @Test
    fun `fileNameFromContentDisposition - attachment with quoted filename and spaces - correct filename extracted`() {
        assertEquals("filename.jpg", DownloaderUtil.fileNameFromContentDisposition("""attachment ; filename="filename.jpg""""))
    }
    ...
    @Test
    fun `fileNameFromContentDisposition - attachment with encoded filename - encoded filename extracted`() {
        assertEquals(
