...
class SyncSharedPrefsStoreTest {
    ...
    @Test
    fun `userId - stored - value updated in prefs store`() {
    ...
    @Test
    fun `deviceName - stored - value updated in prefs store`() {
    ...
    @Test
    fun `deviceId - stored - value updated in prefs store`() {
    ...
    @Test
    fun `isSignedIn - user has auth keys - return true`() {
        store.storeCredentials("userId", "deviceId", "deviceName", "primaryKey", "secretKey", "token")
