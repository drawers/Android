...
class SettingsSyncDataProviderTest {
    ...
    @Test
    fun `getChanges - metadata initialized`() = runTest {
    ...
    @Test
    fun `getChanges - existing metadata updated - changes fetched`() = runTest {
    ...
    @Test
    fun `getChanges - first sync - includes all values`() {
    ...
    @Test
    fun `getChanges - subsequent calls and no changes - updates are empty`() {
        settingSyncStore.serverModifiedSince = "2022-01-01T00:00:00Z"
        settingSyncStore.clientModifiedSince = "2022-01-01T00:00:00Z"
    ...
    @Test
    fun `getChanges - db has data but it's first sync - include all values`() {
        metadataDao.addOrUpdate(SettingsSyncMetadataEntity(duckAddressSetting.key, "2022-01-01T00:00:00Z", ""))
    ...
    @Test
    fun `getChanges - get changes for first sync and setting null - send as deleted`() {
    ...
    @Test
    fun `getChanges - subsequent calls and setting null - send as deleted`() {
        settingSyncStore.serverModifiedSince = "2022-01-01T00:00:00Z"
        settingSyncStore.clientModifiedSince = "2022-01-01T00:00:00Z"
    ...
    @Test
    fun `getChanges - syncable setting not found - skip update`() {
        settingSyncStore.serverModifiedSince = "2022-01-01T00:00:00Z"
        settingSyncStore.clientModifiedSince = "2022-01-01T00:00:00Z"
