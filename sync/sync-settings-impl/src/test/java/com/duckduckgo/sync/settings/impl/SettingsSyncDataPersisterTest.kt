...
class SettingsSyncDataPersisterTest {
    ...
    @Test
    fun `onSuccess - persist changes timestamp and no recent change - call merge with value`() {
    ...
    @Test
    fun `onSuccess - persist changes timestamp with deleted value - save with null`() {
        val result = testee.onSuccess(
            changes = SyncChangesResponse(
                type = SyncableType.SETTINGS,
                jsonString = responseWithDeletedObject,
    ...
    @Test
    fun `onSuccess - persist changes timestamp but recently modified - skip`() {
        settingSyncStore.startTimeStamp = "2023-08-31T10:06:16.022Z"
    ...
    @Test
    fun `onSuccess - update server and client timestamps`() {
        settingSyncStore.startTimeStamp = "2023-08-31T10:06:16.022Z"
