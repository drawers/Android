...
class SyncBarcodeViewModelTest {
    ...
    @Test
    fun `handleCameraAvailability - viewState camera unavailable - camera unavailable`() = runTest {
    ...
    @Test
    fun `handlePermissions - permission granted - view state permissions granted`() = runTest {
    ...
    @Test
    fun `handlePermissions - permission not granted - view state unknown`() = runTest {
        testee.handlePermissions(false)
    ...
    @Test
    fun `handlePermissions - permission not granted and permission already denied - view state permissions not granted`() = runTest {
    ...
    @Test
    fun `goToSettings - viewState unknown - unknown`() = runTest {
        testee.goToSettings()
    ...
    @Test
    fun `onResume - command check camera available - check camera available`() = runTest {
    ...
    @Test
    fun `handleCameraAvailability - camera available - view state unknown`() = runTest {
        testee.handleCameraAvailability(true)
