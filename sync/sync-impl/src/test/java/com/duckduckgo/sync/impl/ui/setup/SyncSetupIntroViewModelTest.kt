...
class SyncSetupIntroViewModelTest {
    ...
    @Test
    fun `syncIntro - intro create account screen shown`() = runTest {
    ...
    @Test
    fun `recoverIntroArgument - intro recovery screen shown`() = runTest {
    ...
    @Test
    fun `onStartRecoverDataClicked - recover data flow command sent`() = runTest {
    ...
    @Test
    fun `onAbortClicked - abort flow command sent`() = runTest {
