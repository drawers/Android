...
class SyncCryptoTest {
    ...
    fun `encrypt - encrypt fails - result is empty`() {
    ...
    @Test
    fun `encrypt - encrypt succeeds - result is encrypted`() {
    ...
    @Test(expected = java.lang.Exception::class)
    fun `decrypt - decrypt fails - result is empty`() {
    ...
    @Test
    fun `decrypt - decrypt succeeds - result is decrypted`() {
    ...
    @Test
    fun `decrypt - data to decrypt is empty - result is empty`() {
