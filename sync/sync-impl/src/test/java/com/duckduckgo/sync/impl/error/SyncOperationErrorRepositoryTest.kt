...
class SyncOperationErrorRepositoryTest {
    ...
    @Test
    fun `addError - not present - new entry added`() {
    ...
    @Test
    fun `getErrors - no errors stored - empty`() {
        val date = DatabaseDateFormatter.getUtcIsoLocalDate()
    ...
    @Test
    fun `addError - getting errors returns data - is not empty and has correct error name and count`() {
        val errorType = SyncOperationErrorType.DATA_ENCRYPT
    ...
    @Test
    fun `getErrorsByDate - feature errors stored - returns data`() {
        val feature = SyncableType.BOOKMARKS
        val errorType = SyncOperationErrorType.DATA_PERSISTER_ERROR
        val today = DatabaseDateFormatter.getUtcIsoLocalDate()
    ...
    @Test
    fun `addError - getting errors returns data - has stored provider errors`() {
        val feature = SyncableType.BOOKMARKS
    ...
    @Test
    fun `whenTimestampErrorsStoredThenGettingErrorsReturnsData - getting errors returns data`() {
        val feature = SyncableType.BOOKMARKS
    ...
    @Test
    fun `getErrorsByDate - orphans errors stored - returns data`() {
        val feature = SyncableType.BOOKMARKS
