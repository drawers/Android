...
class SyncConnectViewModelTest {
    ...
    @Test
    fun `whenScreenStarted - show QR code - shows QR code bitmap`() = runTest {
    ...
    @Test
    fun `generateConnectQR - fails - finish with error`() = runTest {
    ...
    @Test
    fun `whenConnectionKeysSuccess - login success`() = runTest {
        whenever(syncRepository.getConnectQR()).thenReturn(Result.Success(jsonConnectKeyEncoded))
        whenever(syncRepository.pollConnectionKeys()).thenReturn(Result.Success(true))
        testee.viewState().test {
            awaitItem()
    ...
    @Test
    fun `onCopyCodeClicked - clipboard copied`() = runTest {
        whenever(syncRepository.getConnectQR()).thenReturn(Result.Success(jsonConnectKeyEncoded))
    ...
    @Test
    fun `onReadTextCodeClicked - commands - read text code`() = runTest {
        testee.commands().test {
    ...
    @Test
    fun `onQRCodeScanned - connect device succeeds - login success`() = runTest {
    ...
    @Test
    fun `onLoginSuccess - command login success - login success`() = runTest {
        testee.commands().test {
    ...
    @Test
    fun `pollIfConnectFails - view state updated - show error`() = runTest {
    ...
    @Test
    fun `pollIfLoginFails - view state updated - show error`() = runTest {
