...
class SyncDisabledViewModelTest {
    ...
    @Test
    fun `onResume - unauthenticated data syncing disabled - message displayed`() = runTest {
    ...
    @Test
    fun `onResume - unauthenticated data syncing enabled on newer version - message displayed`() = runTest {
    ...
    @Test
    fun `onResume - authenticated user data syncing disabled - message displayed`() = runTest {
        givenAllowDataSyncing(enabled = false)
    ...
    @Test
    fun `onResume - authenticated setup flows disabled - no message displayed`() = runTest {
        givenAllowSetupFlows(enabled = false)
        syncStateFlow.emit(READY)
        testee.onResume(mock())
    ...
    @Test
    fun `onResume - authenticated setup flows enabled on newer version - no message displayed`() = runTest {
        givenAllowSetupFlows(enabledOnNewerVersion = true)
        syncStateFlow.emit(READY)
        testee.onResume(mock())
    ...
    @Test
    fun `onResume - unauthenticated create account disabled - message displayed`() = runTest {
    ...
    @Test
    fun `onResume - create account disabled - no message displayed`() = runTest {
        givenCreateAccountFlows(enabled = false)
        syncStateFlow.emit(READY)
        testee.onResume(mock())
    ...
    @Test
    fun `onResume - authenticated create account enabled on newer version - no message displayed`() = runTest {
        givenCreateAccountFlows(enabledOnNewerVersion = true)
        syncStateFlow.emit(READY)
        testee.onResume(mock())
