...
internal class SyncApiErrorRecorderTest {
    ...
    @Test
    fun `record - content too large error - repository adds error`() {
        val feature = SyncableType.BOOKMARKS
    ...
    @Test
    fun `record - validation error reported - repository adds error`() {
        val feature = SyncableType.BOOKMARKS
    ...
    @Test
    fun `record - first too many requests error - repository adds error`() {
        val feature = SyncableType.BOOKMARKS
    ...
    @Test
    fun `record - second too many requests error - repository adds error`() {
        val feature = SyncableType.BOOKMARKS
