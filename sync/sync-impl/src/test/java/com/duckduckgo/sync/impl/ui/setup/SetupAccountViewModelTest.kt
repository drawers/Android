...
class SetupAccountViewModelTest {
    ...
    @Test
    fun `whenFlowStartedFromSyncIntroViewMode - intro create account command sent`() = runTest {
    ...
    @Test
    fun `whenFlowStartedFromRecoveryIntroViewMode - intro recovery code command sent`() = runTest {
    ...
    @Test
    fun `whenFlowStartedFromConnectionScreenViewThen - recovery code mode`() = runTest {
