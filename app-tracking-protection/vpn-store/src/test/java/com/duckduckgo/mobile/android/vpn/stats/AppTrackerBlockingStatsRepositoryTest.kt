...
class AppTrackerBlockingStatsRepositoryTest {
    ...
    @Test
    fun `whenSameTrackerFoundMultipleTimesTodayThenAllInstancesOfBlockerReturned - all instances of blocker returned`() = runBlocking {
        val trackerDomain = "example.com"
        addTrackerAndReturn(trackerDomain)
        val entity = addTrackerAndReturn(trackerDomain).asEntity()
    ...
    @Test
    fun `containsVpnTrackers - db table not empty - true`() = runTest {
        addTrackerAndReturn()
