...
class NgVpnNetworkStackTest {
    ...
    @Test
    fun `onDnsResolved - is address blocked - tracker domain`() { // false because we don't want to block based on IP addresses
        val uid = 1200
    ...
    @Test
    fun `isAddressBlocked - is not tracker domain - return false`() {
        val uid = 1200
