...
class VpnRoutesTest {
    ...
    @Test
    fun `localIPAddresses - excluded from VPN`() {
    ...
    @Test
    fun `findRoutes - addresses in 97·64·0·0 to 97·127·255·255 range - go through VPN`() {
    ...
    @Test
    fun `findRoutes - addresses in range 98·0·0·0 to 100·63·255·255 - go through VPN`() {
    ...
    @Test
    fun `findRoutes - addresses in range 172·32·0·0 to 174·191·255·255 - go through VPN`() {
    ...
    @Test
    fun `incrementIpAddress - various cases - correct increment`() {
