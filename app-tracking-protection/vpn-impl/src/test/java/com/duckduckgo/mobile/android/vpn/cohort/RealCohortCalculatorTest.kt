...
class RealCohortCalculatorTest {
    ...
    @Test
    fun `calculateCohort - local date first day of last day of 2021 - return monthly cohort`() {
        val date = LocalDate.of(2022, 1, 1)
    ...
    @Test
    fun `calculateCohortForDate - local date is first day of last day of 2021 - return quarter cohort`() {
        val date = LocalDate.of(2022, 1, 1)
    ...
    @Test
    fun `calculateCohortForDate - local date now - weekly cohort`() {
