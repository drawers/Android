...
class TrackingProtectionAppsRepositoryTest {
    ...
    @Test
    fun `getExclusionAppList - return exclusion list`() = runTest {
    ...
    @Test
    fun `getAppProtectionStatus - is protection enabled called on disabled app - returns false`() = runTest {
    ...
    @Test
    fun `getAppProtectionStatus - DdgApp - unprotected`() = runTest {
    ...
    @Test
    fun `getAppProtectionStatus - unknown package - protected`() = runTest {
    ...
    @Test
    fun `getAppProtectionStatus - NameNotFoundException thrown - return protected`() = runTest {
        whenever(packageManager.getApplicationInfo("com.example.unknown", 0))
    ...
    @Test
    fun `manuallyExcludeApp - getExclusionAppsList - addToExclusionList`() = runTest {
    ...
    @Test
    fun `getAppsAndProtectionInfo - app in netp exclusion list - returns apps with protection info`() = runTest {
    ...
    @Test
    fun `getAppsAndProtectionInfo - app in netp exclusion list - return apps with protection info with correct known problem`() = runTest {
        whenever(networkProtectionExclusionList.isExcluded(any())).thenReturn(true)
