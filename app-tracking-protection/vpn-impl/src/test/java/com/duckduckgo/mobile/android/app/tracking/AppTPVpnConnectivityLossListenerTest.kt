...
class AppTPVpnConnectivityLossListenerTest {
    ...
    @Test
    fun `onVpnConnectivityLoss - app tracking protection restarted third consecutive time - stopped`() = runTest {
    ...
    @Test
    fun `restartOnConnectivityLossIsDisabledThenNoop - no restart`() = runTest {
        whenever(networkProtectionState.isEnabled()).thenReturn(false)
        whenever(appTrackingProtection.isEnabled()).thenReturn(true)
    ...
    @Test
    fun `onVpnConnectivityLoss - app tracking protection disabled - no op`() = runTest {
        whenever(networkProtectionState.isEnabled()).thenReturn(true)
