...
class ManageAppsProtectionViewModelTest {
    ...
    @Test
    fun `onAppProtectionEnabled - no issues - enables protection`() = runTest {
        val packageName = "com.package.name"
    ...
    @Test
    fun `onAppProtectionChanged - app manually disabled - show disable protection dialog`() = runTest {
        viewModel.commands().test {
