...
class ReportBreakageContractTest {
    ...
    @Test
    fun `createIntent - whenCreateIntentForIssueDescriptionFormThenReturnCorrectIntent - return correct intent`() {
    ...
    @Test
    fun `createIntent - listOfInstalledApps - returns correct intent`() {
