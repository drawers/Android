...
class VpnFeaturesRegistryImplTest {
    ...
    @Test
    fun `isFeatureRegistered - is feature running - true`() = runTest {
        vpnFeaturesRegistry.registerFeature(TestVpnFeatures.FOO)
        vpnFeaturesRegistry.registerFeature(TestVpnFeatures.BAR)
    ...
    @Test
    fun `registerFeature - is any feature registered and features are not registered - returns false`() = runTest {
        vpnFeaturesRegistry.registerFeature(TestVpnFeatures.FOO)
    }
