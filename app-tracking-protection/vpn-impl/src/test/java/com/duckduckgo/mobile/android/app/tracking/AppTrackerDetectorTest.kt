...
class AppTrackerDetectorTest {
    ...
    @Test
    fun `evaluate - overridden system app not in exclusion list - return tracker`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - third party tracker, system app, in exclusion list - return null`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - overridden system app in exclusion list - return null`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - overridden system app - return tracker`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - third party tracker manually unprotected - return null`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - manually protected third party tracker - return tracker`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - manually protected and in exclusion list - return tracker`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - third party tracker from unknown app - return null`() {
    ...
    @Test
    fun `evaluate - third party tracker from DDG app - return null`() {
    ...
    @Test
    fun `evaluate - first party tracker - return null`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
    ...
    @Test
    fun `evaluate - appTp disabled - return null`() = runTest {
