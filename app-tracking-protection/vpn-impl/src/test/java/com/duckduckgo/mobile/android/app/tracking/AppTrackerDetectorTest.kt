...
class AppTrackerDetectorTest {
    ...
    @Test
    fun `evaluate - third party tracker - returns tracker`() {
    ...
    @Test
    fun `evaluate - third party tracker and overridden system app and not in exclusion list - return tracker`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - third party tracker and system app in exclusion list - returns null`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - third party tracker and overridden system app in exclusion list - returns null`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - third party tracker and manually protected in exclusion list - returns tracker`() {
        whenever(appTrackerRepository.findTracker(TEST_APP_TRACKER.hostname, APP_PACKAGE_ID))
            .thenReturn(AppTrackerType.ThirdParty(TEST_APP_TRACKER))
        whenever(appNameResolver.getPackageIdForUid(APP_UID)).thenReturn(APP_ORIGINATING_APP.packageId)
    ...
    @Test
    fun `evaluate - third party tracker in exclusion list - return tracker null`() {
    ...
    @Test
    fun `whenAppTpDisabled - return null`() = runTest {
