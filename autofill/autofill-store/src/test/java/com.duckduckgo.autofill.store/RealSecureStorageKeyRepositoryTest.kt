...
class RealSecureStorageKeyRepositoryTest {
    ...
    @Test
    fun `getKeyForPassword - key store - gets generated password`() {
    ...
    @Test
    fun `getKeyForPasswordSalt - key store - password salt`() {
    ...
    @Test
    fun `getKeyForEncryptedL2KeyIVInKeyStore - getting encrypted L2 key IV - returns test value`() {
