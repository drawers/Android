...
class CredentialInitialExtractorTest {
    ...
    @Test
    fun `extractInitial - empty string title and domain - placeholder char`() {
    ...
    @Test
    fun `extractInitial - title starts with non-Latin letter that cannot be decomposed - original letter is used`() {
        val loginCredentials = creds(title = "ß website")
        assertEquals("ß", testee.extractInitial(loginCredentials))
    }

    @Test
    fun `extractInitial - domain starts with non-Latin letter - original letter used`() {
        val loginCredentials = creds(title = "ß.com")
        assertEquals("ß", testee.extractInitial(loginCredentials))
    }

    @Test
    fun `extractInitial - title starts with accented letter - base letter is used`() {
        val loginCredentials = creds(title = "Ça va website")
        assertEquals("C", testee.extractInitial(loginCredentials))
    }

    @Test
    fun `extractInitial - domain starts with accented letter - base letter is used`() {
    ...
    @Test
    fun `extractInitial - title starts with non-Latin letter - non-Latin letter used`() {
