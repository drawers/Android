...
internal class CredentialsSyncTest {
    ...
    @Test
    fun `onFirstWithInvalidCredentials - changes do not contain invalid entities`() = runTest {
        givenLocalCredentials(
            invalidCredentials,
        )
    ...
    @Test
    fun `getInvalidCredentials - given local credentials - returns invalid credentials`() = runTest {
        givenLocalCredentials(
            invalidCredentials,
        )
        credentialsSyncStore.invalidEntitiesIds = listOf(credentialsSyncMetadata.getSyncMetadata(invalidCredentials.id!!)!!.syncId)
    ...
    @Test
    fun `getCredentialWithSyncId - returns credentials`() = runTest {
        givenLocalCredentials(
            twitterCredentials,
            spotifyCredentials,
        )
    ...
    @Test
    fun `getCredentialWithSyncId - not found - returns null`() = runTest {
        givenLocalCredentials(
            twitterCredentials,
            spotifyCredentials,
        )
    ...
    @Test
    fun `saveCredential - sync metadata`() = runTest {
    ...
    @Test
    fun `saveCredentialsToExistingSyncId - save to autofill store and override sync id`() = runTest {
