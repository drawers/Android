...
class RealInternalTestUserCheckerTest {
    ...
    @Test
    fun `verifyVerificationErrorReceived - is not internal test user - not internal test user`() {
    ...
    @Test
    fun `verifyVerificationCompleted - is not internal test user - not internal test user`() {
        testee.verifyVerificationCompleted(INVALID_TEST_URL)
    ...
    @Test
    fun `verifyVerificationError - http url - is not internal test user`() {
    ...
    @Test
    fun `verifyVerificationErrorReceived - is not internal test user`() {
    ...
    @Test
    fun `verifyVerificationCompleted - is internal test user - true`() {
        testee.verifyVerificationCompleted(VALID_TEST_HTTPS_URL)
    ...
    @Test
    fun `verifyVerificationCompleted - http url - is internal test user`() {
    ...
    @Test
    fun `whenUserBuildIsInternalNoValidation - is internal test user`() {
    ...
    @Test
    fun `verifyVerificationErrorReceived - internal build and error received - is internal test user`() {
        whenever(appBuildConfig.flavor).thenReturn(INTERNAL)
