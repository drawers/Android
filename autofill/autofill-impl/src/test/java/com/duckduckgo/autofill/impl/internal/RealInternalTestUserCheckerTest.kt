...
class RealInternalTestUserCheckerTest {
    ...
    @Test
    fun `verifyVerificationCompleted - is not internal test user`() {
        testee.verifyVerificationCompleted(INVALID_TEST_URL)
    ...
    @Test
    fun `verifyVerificationError - is not internal test user`() {
    ...
    @Test
    fun `verifyVerificationCompleted - is internal test user`() {
        testee.verifyVerificationCompleted(VALID_TEST_HTTPS_URL)
    ...
    @Test
    fun `verifyVerificationCompleted - is internal test user - valid but http url`() {
    ...
    @Test
    fun `whenAppBuildFlavorIsInternal - is internal test user`() {
    ...
    @Test
    fun `verifyVerificationErrorReceived - is internal test user`() {
        whenever(appBuildConfig.flavor).thenReturn(INTERNAL)
