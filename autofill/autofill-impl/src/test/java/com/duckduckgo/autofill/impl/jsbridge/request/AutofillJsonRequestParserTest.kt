...
class AutofillJsonRequestParserTest {
    ...
    @Test
    fun `parseStoreFormDataJson - username and password both provided - both in response`() = runTest {
    ...
    @Test
    fun `parseStoreFormDataJson - username and password both missing - null`() = runTest {
    ...
    @Test
    fun `parseStoreFormDataJson - password missing - username populated`() = runTest {
    ...
    @Test
    fun `parseStoreFormDataRequest - empty request - exception thrown`() = runTest {
