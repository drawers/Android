...
class RealAutofillRuntimeConfigProviderTest {
    ...
    @Test
    fun `getRuntimeConfiguration - autofill enabled - user prefs credentials is true`() = runTest {
    ...
    @Test
    fun `getRuntimeConfiguration - can autofill - shows key icon`() = runTest {
        configureAutofillCapabilities(enabled = true)
    ...
    @Test
    fun `getRuntimeConfiguration - with credentials for URL - input type credentials is true`() = runTest {
        configureAutofillCapabilities(enabled = true)
    ...
    @Test
    fun `getRuntimeConfiguration - shareable credentials for URL - input type credentials is true`() = runTest {
        configureAutofillCapabilities(enabled = true)
        whenever(autofillStore.getCredentials(EXAMPLE_URL)).thenReturn(emptyList())
    ...
    @Test
    fun `getRuntimeConfiguration - username only for URL - input type credentials username is true`() = runTest {
        val url = "example.com"
        configureAutofillCapabilities(enabled = true)
    ...
    @Test
    fun `getRuntimeConfiguration - password only for URL - input type credentials username is false`() = runTest {
        val url = "example.com"
        configureAutofillCapabilities(enabled = true)
        whenever(autofillStore.getCredentials(url)).thenReturn(
            listOf(
    ...
    @Test
    fun `getRuntimeConfiguration - empty password only for url - input type credentials username is false`() = runTest {
        val url = "example.com"
        configureAutofillCapabilities(enabled = true)
        whenever(autofillStore.getCredentials(url)).thenReturn(
            listOf(
    ...
    @Test
    fun `getRuntimeConfiguration - autofill disabled with credentials - input type credentials is false`() = runTest {
        val url = "example.com"
        configureAutofillCapabilities(enabled = false)
        whenever(autofillStore.getCredentials(url)).thenReturn(
            listOf(
    ...
    @Test
    fun `getRuntimeConfiguration - autofill unavailable - input type credentials is false`() = runTest {
        val url = "example.com"
        configureAutofillCapabilities(enabled = false)
        whenever(autofillStore.getCredentials(url)).thenReturn(
            listOf(
    ...
    @Test
    fun `getRuntimeConfiguration - email is signed in - input type email is true`() = runTest {
        val url = "example.com"
    ...
    @Test
    fun `getRuntimeConfiguration - email is signed out - input type email is false`() = runTest {
        val url = "example.com"
        configureAutofillEnabledWithNoSavedCredentials(url)
    ...
    @Test
    fun `getRuntimeConfiguration - site in never save list - still tell js we can save credentials`() = runTest {
        val url = "example.com"
        configureAutofillEnabledWithNoSavedCredentials(url)
