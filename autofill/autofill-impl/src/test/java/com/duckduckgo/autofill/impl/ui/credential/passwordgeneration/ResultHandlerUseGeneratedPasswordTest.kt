...
class ResultHandlerUseGeneratedPasswordTest {
    ...
    @Test
    fun `processResult - user rejected to use password - correct callback invoked`() {
    ...
    @Test
    fun `processResult - user accepted to use password no auto login in - correct callback invoked`() = runTest {
    ...
    @Test
    fun `processResult - user accepted to use password but password is null - correct callback not invoked`() = runTest {
