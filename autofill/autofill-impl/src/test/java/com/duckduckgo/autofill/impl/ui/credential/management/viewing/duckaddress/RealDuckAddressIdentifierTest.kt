...
class RealDuckAddressIdentifierTest {
    ...
    @Test
    fun `isPrivateDuckAddress - input is only suffix - not a private address`() {
    ...
    @Test
    fun `isPrivateDuckAddress - input matches main address given with suffix - not a private address`() {
    ...
    @Test
    fun `isPrivateDuckAddress - matches main address except input has full address and main address missing suffix - not a private address`() {
        assertFalse(testee.isPrivateDuckAddress("test@duck.com", MAIN_ADDRESS))
    }

    @Test
    fun `isPrivateDuckAddress - input has different duck address from main address - is a private address`() {
