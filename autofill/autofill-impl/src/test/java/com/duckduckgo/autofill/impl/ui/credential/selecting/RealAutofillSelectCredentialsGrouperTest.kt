...
class RealAutofillSelectCredentialsGrouperTest {
    ...
    @Test
    fun `group - single partial match - gets its own group`() {
    ...
    @Test
    fun `group - sorting perfect matches with no last used - last updated sorted first`() {
        val creds = listOf(
    ...
    @Test
    fun `group - sorting perfect matches - last used sorted first`() {
        val creds = listOf(
    ...
    @Test
    fun `group - sorting partial matches with no last used - last updated sorted first`() {
        val creds = listOf(
    ...
    @Test
    fun `group - sorting other matches with no last used - last updated sorted first`() {
        val creds = listOf(
    ...
    @Test
    fun `group - sorting other matches - last used sorted first`() {
        val creds = listOf(
    ...
    @Test
    fun `group - shareable credentials by domain like partial matches`() {
        val creds = listOf(
