...
class RealAutofillSelectCredentialsGrouperTest {
    ...
    @Test
    fun `group - one perfect match - correctly grouped into perfect match`() {
    ...
    @Test
    fun `group - perfect matches with no last used - last updated sorted first`() {
        val creds = listOf(
    ...
    @Test
    fun `group - partial matches with no last used - last updated sorted first`() {
        val creds = listOf(
    ...
    @Test
    fun `group - other matches with no last used - last updated sorted first`() {
        val creds = listOf(
