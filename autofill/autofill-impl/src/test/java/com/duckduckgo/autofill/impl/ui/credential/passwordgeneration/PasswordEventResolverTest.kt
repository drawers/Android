...
class PasswordEventResolverTest {
    ...
    @Test
    fun `whenNoAutoSavedLoginAndNotAutogeneratedCredentialsThenPromptUserToSave - null state - prompt user to save`() {
    ...
    @Test
    fun `whenNoAutoSavedLoginAndAutogeneratedCredentialsThenPromptToSave - null auto saved login and autogenerated credentials - prompt to save`() {
        val autoSavedLogin = null
    ...
    @Test
    fun `whenAutoSavedLoginAndNotAutogeneratedCredentialsThenDeleteAutoLoginAndDiscardAutoLoginIdAndPromptToSave - delete auto login and discard auto login id and prompt to save`() {
    ...
    @Test
    fun `whenAutoSavedLoginAndAutogeneratedCredentialsThenUpdateSavedLogin - auto saved login and autogenerated credentials - update saved login`() {
        val autoSavedLogin = loginCreds(id = 1)
        val actions = testee.decideActions(autoSavedLogin, autogenerated = true)
