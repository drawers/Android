...
internal class CredentialsLastModifiedWinsStrategyTest {
    ...
    @Test fun `processEntries - remote credentials more recent - remote wins`() = runTest {
        givenLocalCredentials(
            twitterCredentials,
            spotifyCredentials,
        )
    ...
    @Test fun `processEntries - credential updated after changes timestamp then local wins`() = runTest {
        givenLocalCredentials(
    ...
    @Test fun `processEntries - local has more credentials - update with more recent and keep others`() = runTest {
        givenLocalCredentials(
            twitterCredentials,
            spotifyCredentials,
            amazonCredentials,
    ...
    @Test fun `processEntries - remote empty - no changes`() = runTest {
        givenLocalCredentials(
            twitterCredentials,
            spotifyCredentials,
        )
    ...
    @Test fun `processEntries - remote more recent and deleted - remote wins`() = runTest {
        givenLocalCredentials(
            twitterCredentials,
            spotifyCredentials,
        )
