...
class SyncCredentialsListenerTest {
    ...
    @Test
    fun `onCredentialAdded - recently removed credential - does not update metadata`() = runTest {
        testee.onCredentialAdded(1)
    ...
    @Test
    fun `onCredentialRemoved - reinserting credentials recently removed - cancel delete operation and do not update metadata`() = runTest {
        testee.onCredentialsAdded(listOf(1, 2, 3, 4, 5))
