...
class CredentialGrouperTest {
    ...
    @Test
    fun `group - list with missing domain and title - grouped into placeholder`() {
        val credentials = listOf(
            creds(domain = "amazon.com", title = "Smile Amazon"),
    ...
    @Test
    fun `group - characters deconstructed - do not get their own group`() {
        val credentials = listOf(
            creds(title = "ä"),
            creds(title = "A"),
            creds(title = "Ğ"),
    ...
    @Test
    fun `group - emoji in placeholder`() {
        val credentials = listOf(
            creds(title = "😅"),
        )
        val grouped = testee.group(credentials)
    ...
    @Test
    fun `group - number credentials - grouped into placeholder`() {
        val credentials = listOf(
            creds(title = "8"),
            creds(title = "5"),
        )
