...
class CredentialGrouperTest {
    ...
    @Test
    fun `group - characters deconstructed - no group for each`() {
        val credentials = listOf(
            creds(title = "ä"),
            creds(title = "A"),
            creds(title = "Ğ"),
    ...
    @Test
    fun `group - emoji in placeholder - heading found`() {
        val credentials = listOf(
            creds(title = "😅"),
        )
        val grouped = testee.group(credentials)
    ...
    @Test
    fun `group - number then grouped into placeholder`() {
        val credentials = listOf(
            creds(title = "8"),
            creds(title = "5"),
        )
    ...
    @Test
    fun `whenListMixtureOfAccentedCharactersThenAccentedCharactersDoNotGetTheirOwnGroups - group credentials`() {
        val credentials = listOf(
            creds(title = "A"),
            creds(title = "Ab"),
            creds(title = "ab"),
