...
class AutofillSavingPixelEventNamesTest {
    ...
    @Test
    fun `savingAcceptedWithUsernameAndPassword - correct pixel used`() {
        assertEquals(pixelNameDialogAccepted(UsernameAndPassword), AUTOFILL_SAVE_LOGIN_PROMPT_SAVED)
    }

    @Test
    fun `savingAcceptedWithPasswordOnly - correct pixel used`() {
    ...
    @Test
    fun `saveType - username and password provided - username and password`() {
