...
class ResultHandlerUpdateLoginCredentialsTest {
    ...
    @Test
    fun `processResult - missing url - no attempt to update made`() = runTest {
    ...
    @Test
    fun `processResult - missing credentials - no attempt to save made`() = runTest {
        val bundle =
    ...
    @Test
    fun `processResult - well formed bundle - credentials are updated`() = runTest {
