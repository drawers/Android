...
class ResultHandlerUpdateLoginCredentialsTest {
    ...
    @Test
    fun `whenUpdateBundleMissingUrlThenNoAttemptToUpdateMade - no attempt to update made`() = runTest {
    ...
    @Test
    fun `whenUpdateBundleMissingCredentialsThenNoAttemptToSaveMade - no attempt to save made`() = runTest {
        val bundle =
    ...
    @Test
    fun `whenUpdateBundleWellFormedThenCredentialsAreUpdated - update bundle well formed - credentials are updated`() = runTest {
