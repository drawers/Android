...
class CredentialListSorterTest {
    ...
    @Test
    fun `sort - list is empty - return empty list`() {
        val result = testee.sort(emptyList())
        assertTrue(result.isEmpty())
    }

    @Test
    fun `sort - titles case ignored`() {
    ...
    @Test
    fun `sort - comparing domains - case is ignored`() {
        val sorted = testee.sort(
            list.also {
    ...
    @Test
    fun `sort - title starts with a character - sorted before letters`() {
        val sorted = testee.sort(
            list.also {
                it.add(credsWithTitle("1"))
    ...
    @Test
    fun `sort - subdomains - www not treated as special`() {
        val sorted = testee.sort(
            list.also {
    ...
    @Test
    fun `sort - invalid domain initial - used for sort`() {
        val sorted = testee.sort(
            list.also {
                it.add(credsWithDomain("http://b.com"))
                it.add(credsWithDomain("c.com"))
    ...
    @Test
    fun `sort - combination of domains and titles - titles take preference`() {
    ...
    @Test
    fun `sort - multiple similar characters in title - correct order`() {
        val sorted = testee.sort(
            list.also {
                it.add(credsWithTitle("a"))
    ...
    @Test
    fun `sort - multiple similar characters in domain - correct order`() {
        val sorted = testee.sort(
            list.also {
    ...
    @Test
    fun `sort - subdomains with sites from same domain without subdomain - top site sorted first`() {
        val sorted = testee.sort(
            list.also {
                it.add(credsWithDomain(id = 0, domain = "www.example.com"))
                it.add(credsWithDomain(id = 1, domain = "accounts.example.com"))
    ...
    @Test
    fun `sort - mixture of titles and subdomains - correct order`() {
        val sorted = testee.sort(
            list.also {
    ...
    @Test
    fun `sort - domains start with decomposable letter - is decomposed in ordering`() {
