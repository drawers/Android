...
class CredentialListSorterTest {
    ...
    @Test
    fun `sort - comparing titles - case is ignored`() {
    ...
    @Test
    fun `sort - comparing domains - http schema ignored`() {
        val sorted = testee.sort(
            list.also {
    ...
    @Test
    fun `sort - multiple similar characters in title - correct sorting`() {
        val sorted = testee.sort(
            list.also {
                it.add(credsWithTitle("a"))
    ...
    @Test
    fun `sort - subdomains with same domain without subdomain - top site sorted first`() {
        val sorted = testee.sort(
            list.also {
                it.add(credsWithDomain(id = 0, domain = "www.example.com"))
                it.add(credsWithDomain(id = 1, domain = "accounts.example.com"))
