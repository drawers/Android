...
class RealVoiceSearchFeatureRepositoryTest {
    ...
    @Test
    fun `RealVoiceSearchFeatureRepository - repository created - exceptions loaded into memory`() = runTest {
    ...
    @Test
    fun `updateAllExceptions - database is updated`() = runTest {
        repository = RealVoiceSearchFeatureRepository(mockDatabase, TestScope(), coroutineRule.testDispatcherProvider, isMainProcess = true)
    ...
    @Test
    fun `updateAllExceptions - previous exceptions - cleared`() = runTest {
        givenDaoContainsExceptions()
        repository = RealVoiceSearchFeatureRepository(mockDatabase, TestScope(), coroutineRule.testDispatcherProvider, isMainProcess = true)
