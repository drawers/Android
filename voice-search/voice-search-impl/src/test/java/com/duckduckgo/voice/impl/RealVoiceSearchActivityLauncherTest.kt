...
class RealVoiceSearchActivityLauncherTest {
    ...
    @Test
    fun `whenResultFromVoiceSearchBrowserIsOKAndNotEmptyThenEmitVoiceRecognitionSuccess - result from voice search browser is OK and not empty - emit voice recognition success`() {
    ...
    @Test
    fun `whenResultFromVoiceSearchBrowserIsErrorThenEmitVoiceRecognitionError - emit voice recognition error`() {
        var lastKnownEvent: Event? = null
        testee.registerResultsCallback(mock(), mock(), BROWSER) {
            lastKnownEvent = it
        }
    ...
    @Test
    fun `whenResultFromVoiceSearchWidgetIsOKAndNotEmptyThenEmitVoiceRecognitionSuccess - result from voice search widget is OK and not empty - emit voice recognition success`() {
        var lastKnownEvent: Event? = null
    ...
    @Test
    fun `whenResultFromVoiceSearchIsOKAndEmptyThenEmitSearchCancelled - emit search cancelled`() {
        var lastKnownEvent: Event? = null
        testee.registerResultsCallback(mock(), mock(), BROWSER) {
            lastKnownEvent = it
        }
    ...
    @Test
    fun `whenResultFromVoiceSearchIsCancelledThenEmitSearchCancelled - emit search cancelled`() {
        var lastKnownEvent: Event? = null
        testee.registerResultsCallback(mock(), mock(), BROWSER) {
            lastKnownEvent = it
        }
    ...
    @Test
    fun `whenResultFromVoiceSearchIsCancelledSeveralTimesThenShowDialog - show dialog`() {
        var lastKnownEvent: Event? = null
        testee.registerResultsCallback(mock(), mock(), BROWSER) {
            lastKnownEvent = it
        }
    ...
    @Test
    fun `whenResultFromVoiceSearchIsCancelledLessThanTwoTimesThenDoNotShowDialog - do not show dialog`() {
        var lastKnownEvent: Event? = null
        testee.registerResultsCallback(mock(), mock(), BROWSER) {
            lastKnownEvent = it
        }
    ...
    @Test
    fun `whenResultFromVoiceSearchIsOkThenResetDismissedCounter - reset dismissed counter`() {
        var lastKnownEvent: Event? = null
        testee.registerResultsCallback(mock(), mock(), BROWSER) {
            lastKnownEvent = it
        }
    ...
    @Test
    fun `launch - browser voice search launched - emit started pixel and call launch voice search`() {
        testee.registerResultsCallback(mock(), mock(), BROWSER) { }
    ...
    @Test
    fun `launch - widget voice search launched - emit started pixel and call launch voice search`() {
        testee.registerResultsCallback(mock(), mock(), WIDGET) { }
