...
class RealBrokenSiteReportRepositoryTest {
    ...
    @Test
    fun `getLastSentDay - empty hostname - return null`() = runTest {
        val hostname = ""
    ...
    @Test
    fun `getLastSentDay - new hostname - return null`() = runTest {
    ...
    @Test
    fun `getLastSentDay - existing hostname - return last seen day`() = runTest {
        val hostname = "www.example.com"
        val hostnameHashPrefix = "80fc0f"
    ...
    @Test
    fun `setLastSentDay - empty hostname - upsertBrokenSiteReport is never called`() = runTest {
        val hostname = ""
    ...
    @Test
    fun `setLastSentDay - non-empty hostname - upsertBrokenSiteReport called`() = runTest {
        val hostname = "www.example.com"
