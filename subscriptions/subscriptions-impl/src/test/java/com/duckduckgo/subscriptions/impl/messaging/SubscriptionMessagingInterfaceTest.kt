...
class SubscriptionMessagingInterfaceTest {
    ...
    @Test
    fun `processNoUrl - do nothing`() = runTest {
    ...
    @Test
    fun `processAndGetSubscriptions - active - return response`() = runTest {
        givenInterfaceIsRegistered()
        givenAuthTokenIsSuccess()
    ...
    @Test
    fun `processAndGetSubscriptionOptionsMessageIfFeatureNameDoesNotMatch - do nothing`() = runTest {
        givenInterfaceIsRegistered()
    ...
    @Test
    fun `processAndFeatureSelectedMessage - url not in allow listed domains - do nothing`() = runTest {
        messagingInterface.register(webView, callback)
