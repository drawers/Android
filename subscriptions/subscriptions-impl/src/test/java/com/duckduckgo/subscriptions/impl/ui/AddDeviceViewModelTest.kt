...
class AddDeviceViewModelTest {
    ...
    @Test
    fun `useEmail - subscription failure - emit error`() = runTest {
    ...
    @Test
    fun `useEmail - email blank - emit AddEmail`() = runTest {
    ...
    @Test
    fun `useEmail - email null - emit AddEmail`() = runTest {
        whenever(subscriptionsManager.getAccount()).thenReturn(
    ...
    @Test
    fun `useEmail - email present - emit manage`() = runTest {
        whenever(subscriptionsManager.getAccount()).thenReturn(
    ...
    @Test
    fun `useEmail - pixel is sent`() = runTest {
        viewModel.useEmail()
