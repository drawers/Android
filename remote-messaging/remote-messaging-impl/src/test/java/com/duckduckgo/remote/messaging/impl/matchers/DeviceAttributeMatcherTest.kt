...
class DeviceAttributeMatcherTest {
    ...
    @Test
    fun `evaluate - device matches locale - return match`() = runTest {
    ...
    @Test
    fun `evaluate - device matches any locale - return match`() = runTest {
        givenDeviceProperties(locale = java.util.Locale.US)
    ...
    @Test
    fun `evaluate - locale matching attribute is empty - return fail`() = runTest {
        givenDeviceProperties(locale = java.util.Locale.US)
    ...
    @Test
    fun `evaluate - different OS API level - return fail`() = runTest {
        givenDeviceProperties(apiLevel = 21)
    ...
    @Test
    fun `evaluate - device matches OS API level - return match`() = runTest {
        givenDeviceProperties(apiLevel = 21)
    ...
    @Test
    fun `evaluate - device matches OS API level range - return match`() = runTest {
        givenDeviceProperties(apiLevel = 21)
    ...
    @Test
    fun `evaluate - device does not match OS API level range - return false`() = runTest {
    ...
    @Test
    fun `evaluate - device WV lower than max WV version - return match`() = runTest {
        givenDeviceProperties(webView = "96.0.4664.104")
    ...
    @Test
    fun `evaluate - device WV greater than min WV version - return match`() = runTest {
    ...
    @Test
    fun `evaluate - device matches WebView max version - return match`() = runTest {
        givenDeviceProperties(webView = "96.0.4664.104")
    ...
    @Test
    fun `evaluate - device matches WebView min version - return match`() = runTest {
        givenDeviceProperties(webView = "96.0.4664.104")
    ...
    @Test
    fun `evaluate - device WV matches max simplified WV version - return match`() = runTest {
        givenDeviceProperties(webView = "96.0.4664.104")
    ...
    @Test
    fun `evaluate - device WebView matches min simplified WebView version - return match`() = runTest {
        givenDeviceProperties(webView = "96.0.4664.104")
    ...
    @Test
    fun `evaluate - device WebView greater than max simplified WebView version - return fail`() = runTest {
        givenDeviceProperties(webView = "96.0.4664.104")
    ...
    @Test
    fun `evaluate - device WV version has unknown format - return fail`() = runTest {
    ...
    @Test
    fun `evaluate - empty WebView matching attribute - return fail`() = runTest {
        givenDeviceProperties(webView = "96.0.4664.104")
