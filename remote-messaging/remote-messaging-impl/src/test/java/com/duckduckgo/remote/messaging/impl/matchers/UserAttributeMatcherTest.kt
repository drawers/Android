...
class UserAttributeMatcherTest {
    ...
    @Test
    fun `evaluate - app theme matches - return match`() = runTest {
    ...
    @Test
    fun `evaluate - bookmarks match - return match`() = runTest {
    ...
    @Test
    fun `evaluate - bookmarks do not match - return fail`() = runTest {
        givenBrowserProperties(bookmarks = 10L)
    ...
    @Test
    fun `evaluate - bookmarks in range - return match`() = runTest {
        givenBrowserProperties(bookmarks = 10L)
    ...
    @Test
    fun `evaluate - bookmarks not in range - return false`() = runTest {
        givenBrowserProperties(bookmarks = 10L)
    ...
    // Favorites
    @Test
    fun `evaluate - favorites match - return match`() = runTest {
    ...
    @Test
    fun `evaluate - favorites do not match - return fail`() = runTest {
        givenBrowserProperties(favorites = 10L)
    ...
    @Test
    fun `evaluate - favorites in range - return match`() = runTest {
        givenBrowserProperties(favorites = 10L)
    ...
    @Test
    fun `evaluate - favorites not in range - return false`() = runTest {
        givenBrowserProperties(favorites = 10L)
    ...
    // DaysUsedSince
    @Test
    fun `evaluate - days used since matches - return match`() = runTest {
    ...
    // DefaultBrowser
    @Test
    fun `evaluate - default browser matches - return match`() = runTest {
    ...
    // EmailEnabled
    @Test
    fun `evaluate - email enabled matches - return match`() = runTest {
    ...
    // SearchCount
    @Test
    fun `evaluate - search count matches - return match`() = runTest {
    ...
    @Test
    fun `evaluate - search count equal or lower than max - return match`() = runTest {
        givenBrowserProperties(searchCount = 10L)
    ...
    @Test
    fun `evaluate - search count in range - return match`() = runTest {
        givenBrowserProperties(searchCount = 10L)
