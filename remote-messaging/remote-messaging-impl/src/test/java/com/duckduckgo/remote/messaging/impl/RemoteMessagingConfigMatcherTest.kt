...
class RemoteMessagingConfigMatcherTest {
    ...
    @Test
    fun `evaluate - matching message excluded by multiple rules - return null`() = runBlocking {
    ...
    @Test
    fun `evaluate - multiple matching messages with some excluded - return first non-excluded match`() = runBlocking {
        givenDeviceMatches(Api(max = 19), Locale(value = listOf("en-US")))
    ...
    @Test
    fun `evaluate - device matches message rules - return first match`() = runBlocking {
    ...
    @Test
    fun `evaluate - device matches multiple message rules - return first match`() = runBlocking {
        givenDeviceMatches(Api(max = 19))
    ...
    @Test
    fun `evaluate - device matches one of multiple message rules - return match`() = runBlocking {
        givenDeviceMatches(Api(max = 19), EmailEnabled(value = true))
    ...
    @Test
    fun `evaluate - user dismissed first message and device matches multiple messages - return first match not dismissed`() = runBlocking {
        givenDeviceMatches(Api(max = 19), EmailEnabled(value = true))
    ...
    @Test
    fun `evaluate - device does not match any rule - return null`() = runBlocking {
    ...
    @Test
    fun `evaluate - device matches message rules and part of percentile - return message`() = runBlocking {
        givenDeviceMatches(Api(max = 19))
    ...
    @Test
    fun `evaluate - device matches message rules but out of percentile - return null`() = runBlocking {
        givenDeviceMatches(Api(max = 19))
    ...
    @Test
    fun `evaluate - matching message excluded and user part of percentile - return null`() = runBlocking {
    ...
    @Test
    fun `evaluate - matching message out of percentile - return message`() = runBlocking {
        givenDeviceMatches(Locale(value = listOf("en-US")))
        cohortDao.insert(RemoteMessagingCohort(messageId = "message1", percentile = 0.5f))
