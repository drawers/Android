...
class AndroidAppAttributeMatcherTest {
    ...
    @Test
    fun `evaluate - flavor matches - return match`() = runTest {
    ...
    @Test
    fun `evaluate - appId matches - return match`() = runTest {
    ...
    @Test
    fun `evaluate - app version in range - return match`() = runTest {
    ...
    @Test
    fun `evaluate - app version different to device - return fail`() = runTest {
        givenDeviceProperties(appVersion = "5.99.0")
    ...
    @Test
    fun `evaluate - app ATB matches - return match`() = runTest {
    ...
    @Test
    fun `evaluate - search ATB matches - return match`() = runTest {
    ...
    @Test
    fun `evaluate - installed GPlay matches - return match`() = runTest {
    ...
    @Test
    fun `evaluate - installed GPlay does not match - return fail`() = runTest {
