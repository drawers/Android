...
class SitePermissionsRepositoryTest {
    ...
    @Test
    fun `isDomainAllowedToAsk - permission disabled - domain not allowed`() {
    ...
    @Test
    fun `isDomainAllowedToAsk - no site permission and DRM blocked - not allowed`() {
    ...
    @Test
    fun `isDomainAllowedToAsk - site permission setting is ask and DRM blocked - domain is allowed to ask`() {
    ...
    @Test
    fun `sitePermissionsForAllWebsites - get all sites permissions`() = runTest {
    ...
    @Test
    fun `getSitePermissionsForWebsite - calls getSitePermissionsByDomain`() = runTest {
