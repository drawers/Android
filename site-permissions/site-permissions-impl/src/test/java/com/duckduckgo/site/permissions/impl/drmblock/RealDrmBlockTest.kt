...
class RealDrmBlockTest {
    ...
    @Test
    fun `isDrmBlockedForUrl - feature disabled - false returned`() {
        assertFalse(testee.isDrmBlockedForUrl(url))
    }

    @Test
    fun `isDrmBlockedForUrl - feature enabled and URL not blocked - false returned`() {
    ...
    @Test
    fun `isDrmBlockedForUrl - feature enabled, URL blocked, user allowed - false returned`() {
        givenFeatureIsEnabled()
    ...
    @Test
    fun `isDrmBlockedForUrl - feature enabled, url blocked, not user allowed, unprotected temp - false returned`() {
        givenFeatureIsEnabled()
        givenUrlIsInExceptionList()
    ...
    @Test
    fun `isDrmBlockedForUrl - feature enabled and url in exception list - true returned`() {
        givenFeatureIsEnabled()
        givenUrlIsInExceptionList()
