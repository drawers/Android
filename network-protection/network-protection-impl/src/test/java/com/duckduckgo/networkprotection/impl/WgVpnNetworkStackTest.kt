...
class WgVpnNetworkStackTest {
    ...
    @Test
    fun `onPrepareVpn - returns vpn tunnel config and stores server details`() = runTest {
    ...
    @Test
    fun `onPrepareVpn - wgTunnel data provider throws exception - should return failure`() = runTest {
    ...
    @Test
    fun `onStartVpn - wg protocol start returns success - should return success`() = runTest {
