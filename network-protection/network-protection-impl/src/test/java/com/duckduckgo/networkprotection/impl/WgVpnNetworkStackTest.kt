...
class WgVpnNetworkStackTest {
    ...
    @Test
    fun `onStartVpn - enabled time reset - set enabled time in milliseconds`() = runTest {
        whenever(wgTunnel.createAndSetWgConfig()).thenReturn(wgConfig.success())
    ...
    @Test
    fun `onStartVpn - enabled time set - do not update enabled time`() = runTest {
    ...
    @Test
    fun `onStopVpn - self stop - reset enabled time and server details`() = runTest {
        assertEquals(
            Result.success(Unit),
    ...
    @Test
    fun `onStopVpn - restart - reset enabled time and server details`() = runTest {
        assertEquals(
            Result.success(Unit),
    ...
    @Test
    fun `onPrepare - wgTunnel data provider throws exception - on prepare should return failure`() = runTest {
    ...
    @Test
    fun `onStartVpn - wg protocol start wg returns failure - on start vpn should return failure`() = runTest {
    ...
    @Test
    fun `onStartVpn - wg protocol start successful - on start vpn success`() = runTest {
