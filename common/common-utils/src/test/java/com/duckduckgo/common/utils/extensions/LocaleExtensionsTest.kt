...
class LocaleExtensionsTest {
    ...
    @Test
    fun `whenHasUnicodeLocaleExtensionThenRemoveUnicodeLocaleExtension - remove unicode locale extension`() {
    ...
    @Test
    fun `whenDoesNotHaveUnicodeLocaleExtension - language tag unchanged`() {
        val locale = Locale.Builder()
            .setLanguage("en")
            .setRegion("US")
            .build()
