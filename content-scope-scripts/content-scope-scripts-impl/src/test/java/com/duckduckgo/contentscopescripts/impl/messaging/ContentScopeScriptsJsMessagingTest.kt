...
class ContentScopeScriptsJsMessagingTest {
    ...
    @Test
    fun `processUnknownSecret - do nothing - counter unchanged`() = runTest {
        givenInterfaceIsRegistered()
    ...
    @Test
    fun `processAndWebShare - callback executed and not response sent`() = runTest {
        givenInterfaceIsRegistered()
    ...
    @Test
    fun `processAndWebShareIfFeatureNameDoesNotMatch - do nothing`() = runTest {
        givenInterfaceIsRegistered()
    ...
    @Test
    fun `processAndWebShareIfIdDoesNotExist - do nothing`() = runTest {
        givenInterfaceIsRegistered()
    ...
    @Test
    fun `processAndPermissionsQuery - callback executed and not response sent`() = runTest {
        givenInterfaceIsRegistered()
    ...
    @Test
    fun `processAndPermissionsQuery - id does not exist - do nothing`() = runTest {
        givenInterfaceIsRegistered()
