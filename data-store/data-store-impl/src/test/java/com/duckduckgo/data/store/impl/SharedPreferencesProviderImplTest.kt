...
class SharedPreferencesProviderImplTest {
    ...
    @Test
    fun `getMultiprocessPreferences - migrate to harmony - migrated`() {
    ...
    @Test
    fun `testSafeSharedPreferences - safe shared preferences - all values set and retrieved correctly`() {
