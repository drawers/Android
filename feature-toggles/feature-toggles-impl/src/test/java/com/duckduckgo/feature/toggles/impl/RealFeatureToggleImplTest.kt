...
class RealFeatureToggleImplTest {
    ...
    @Test
    fun `isFeatureEnabled - feature name can be handled by plugin - return correct value`() {
    ...
    fun `isFeatureEnabled - feature name cannot be handled by any plugin - throw exception`() {
