...
class RequestFiltererFeaturePluginTest {
    ...
    @Test
    fun `store - feature name does not match request filterer - return false`() {
    ...
    @Test
    fun `store - feature name matches request filterer - return true`() {
    ...
    @Test
    fun `store - feature name matches request filterer - update all existing values`() {
        val jsonString = FileUtilities.loadText(RequestFiltererFeaturePluginTest::class.java.classLoader!!, "json/request_filterer.json")
