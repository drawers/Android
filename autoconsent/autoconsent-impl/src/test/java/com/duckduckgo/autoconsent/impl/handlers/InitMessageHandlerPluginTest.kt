...
class InitMessageHandlerPluginTest {
    ...
    @Test
    fun `process - message type is not init - do nothing`() {
    ...
    @Test
    fun `process - autoconsent disabled and not handled - do not call evaluate`() {
        settingsRepository.userSetting = false
    ...
    @Test
    fun `process - message for first time - do not call evaluate`() {
    ...
    @Test
    fun `process - message response sent - correct`() {
    ...
    @Test
    fun `process - message - onResultReceived called`() {
        settingsRepository.userSetting = true
        settingsRepository.firstPopupHandled = true
