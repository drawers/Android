...
class RealAutoconsentExceptionsRepositoryTest {
    ...
    @Test
    fun `RealAutoconsentExceptionsRepository - repository created - exceptions loaded into memory`() {
    ...
    @Test
    fun `insertAllExceptions - update all called`() = runTest {
        repository = RealAutoconsentExceptionsRepository(TestScope(), coroutineRule.testDispatcherProvider, mockDatabase, isMainProcess = true)
    ...
    @Test
    fun `insertAllExceptions - previous exceptions are cleared`() = runTest {
        givenDaoContainsExceptions()
        repository = RealAutoconsentExceptionsRepository(TestScope(), coroutineRule.testDispatcherProvider, mockDatabase, isMainProcess = true)
