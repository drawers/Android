...
class RealAutoconsentTest {
    ...
    @Test
    fun `isSettingEnabled - return value from repo`() {
        settingsRepository.userSetting = false
    ...
    @Test
    fun `setAutoconsentOptOut - evaluateJavascript called`() {
        val expected = """
        javascript:(function() {
    ...
    @Test
    fun `setAutoconsentOptOut - true value stored`() {
        autoconsent.setAutoconsentOptOut(webView)
        assertTrue(settingsRepository.userSetting)
    }

    @Test
    fun `setAutoconsentOptIn - false value stored`() {
        autoconsent.setAutoconsentOptIn()
        assertFalse(settingsRepository.userSetting)
    }

    @Test
    fun `firstPopUpHandled - false value stored`() {
