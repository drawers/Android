...
class OptOutAndAutoconsentDoneMessageHandlerPluginTest {
    ...
    @Test
    fun `process - opt out fails - send result with failure`() {
    ...
    @Test
    fun `process - autoconsent done with cosmetic - result sent with cosmetic set to true`() {
    ...
    @Test
    fun `process - self test opt out - autoconsent calls evaluateJavascript`() {
        val expected = """
        javascript:(function() {
