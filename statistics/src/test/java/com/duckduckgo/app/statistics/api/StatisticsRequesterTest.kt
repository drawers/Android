...
class StatisticsRequesterTest {
    ...
    @Test
    fun `refreshSearchRetentionAtb - update version present - previous atb replaced`() {
    ...
    @Test
    fun `refreshSearchRetentionAtb - update version present - previous variant replaced with default variant`() {
        configureStoredStatistics()
        whenever(mockService.updateSearchAtb(any(), any(), any(), eq(0))).thenReturn(Observable.just(UPDATE_ATB))
        testee.refreshSearchRetentionAtb()
    ...
    @Test
    fun `refreshAppRetentionAtb - update version present - previous atb replaced`() {
        configureStoredStatistics()
    ...
    @Test
    fun `refreshAppRetentionAtb - update version present - previous variant replaced with default variant`() {
        configureStoredStatistics()
        whenever(mockService.updateAppAtb(any(), any(), any(), eq(0))).thenReturn(Observable.just(UPDATE_ATB))
        testee.refreshAppRetentionAtb()
        verify(mockStatisticsStore).variant = ""
    ...
    @Test
    fun `refreshSearchRetentionAtb - no statistics stored - retrieves atb and invokes exti`() {
        configureNoStoredStatistics()
        testee.refreshSearchRetentionAtb()
    ...
    @Test
    fun `refreshAppRetentionAtb - no statistics stored - retrieves atb and invokes exti`() {
        configureNoStoredStatistics()
        testee.refreshAppRetentionAtb()
        verify(mockService).atb(any(), any())
        verify(mockService).exti(eq(ATB_WITH_VARIANT), any())
    ...
    @Test
    fun `refreshSearchRetentionAtb - statistics stored - includes refreshed atb`() {
        configureStoredStatistics()
    ...
    @Test
    fun `refreshSearchRetentionAtb - statistics stored - updates atb`() {
        configureStoredStatistics()
        testee.refreshSearchRetentionAtb()
    ...
    @Test
    fun `refreshSearchRetentionAtb - email enabled - email signal to true`() {
        whenever(mockEmailManager.isSignedIn()).thenReturn(true)
        configureStoredStatistics()
    ...
    @Test
    fun `refreshAppRetentionAtb - email enabled - email signal to true`() {
        whenever(mockEmailManager.isSignedIn()).thenReturn(true)
        configureStoredStatistics()
