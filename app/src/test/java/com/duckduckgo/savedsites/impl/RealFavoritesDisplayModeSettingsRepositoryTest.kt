...
class RealFavoritesDisplayModeSettingsRepositoryTest {
    ...
    @Test
    fun `displayMode changed - view state updated`() = runTest {
        testee.favoritesDisplayModeFlow().test {
            awaitItem()
    ...
    @Test
    fun `displayMode changed - notify syncable setting`() = runTest {
        testee.favoritesDisplayMode = UNIFIED
    ...
    @Test
    fun `getDeleteFolder - sync enabled and native mode and favorite is desktop - mobile`() = runTest {
