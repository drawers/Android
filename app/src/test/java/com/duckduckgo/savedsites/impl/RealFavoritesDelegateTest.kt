...
class RealFavoritesDelegateTest {
    ...
    @Test
    fun `getFavoritesSync - native mode - returns mobile favorites folder list`() = runTest {
        givenFavoriteDelegate(favoritesDisplayModeSettings.apply { favoritesDisplayMode = NATIVE })
        val favoriteone = Favorite("favorite1", "Favorite", "http://favexample.com", "timestamp", 0)
        val favoritetwo = Favorite("favorite2", "Favorite2", "http://favexample.com", "timestamp", 1)
        val favoritethree = Favorite("favorite3", "Favorite3", "http://favexample.com", "timestamp", 2)
    ...
    @Test
    fun `favoritesCount - unified mode favorites count - only check root folder`() = runTest {
        givenFavoriteDelegate(favoritesDisplayModeSettings.apply { favoritesDisplayMode = UNIFIED })
        val favoriteone = Favorite("favorite1", "Favorite", "http://favexample.com", "timestamp", 0)
        val favoritetwo = Favorite("favorite2", "Favorite2", "http://favexample.com", "timestamp", 1)
        val favoritethree = Favorite("favorite3", "Favorite3", "http://favexample.com", "timestamp", 2)
    ...
    @Test
    fun `favoritesCount - native mode favorites count - only check mobile folder`() = runTest {
        givenFavoriteDelegate(favoritesDisplayModeSettings.apply { favoritesDisplayMode = NATIVE })
        val favoriteone = Favorite("favorite1", "Favorite", "http://favexample.com", "timestamp", 0)
        val favoritetwo = Favorite("favorite2", "Favorite2", "http://favexample.com", "timestamp", 1)
        val favoritethree = Favorite("favorite3", "Favorite3", "http://favexample.com", "timestamp", 2)
    ...
    @Test
    fun `updateWithPosition - update items on root folder - entities updated`() {
        givenFavoriteDelegate(syncDisabledFavoritesSettings)
        val favoriteone = Favorite("favorite1", "Favorite", "http://favexample.com", "timestamp", 0)
        val favoritetwo = Favorite("favorite2", "Favorite2", "http://favexample.com", "timestamp", 1)
        val favoritethree = Favorite("favorite3", "Favorite3", "http://favexample.com", "timestamp", 2)
    ...
    @Test
    fun `updateWithPosition - items on root folder updated`() = runTest {
        givenFavoriteDelegate(favoritesDisplayModeSettings.apply { favoritesDisplayMode = NATIVE })
        val favoriteone = Favorite("favorite1", "Favorite", "http://favexample.com", "timestamp", 0)
        val favoritetwo = Favorite("favorite2", "Favorite2", "http://favexample.com", "timestamp", 1)
        val favoritethree = Favorite("favorite3", "Favorite3", "http://favexample.com", "timestamp", 2)
    ...
    @Test
    fun `insertFavorite - update items on root folder - favorites updated`() {
        givenFavoriteDelegate(syncDisabledFavoritesSettings)
    ...
    @Test
    fun `deleteFavorite - state - favorite deleted from root folder`() = runTest {
        givenFavoriteDelegate(syncDisabledFavoritesSettings)
