...
class SurveyDownloaderTest {
    ...
    @Test
    fun `whenSurveyForEmailReceivedAndUserIsSignedIn - create survey with correct cohort`() {
    ...
    @Test
    fun `download - new survey allocated and user is not eligible - saved as scheduled`() = runTest {
