...
class SurveyActionMapperTest {
    ...
    @Test
    fun `evaluate - type is survey - return action survey`() {
    ...
    @Test
    fun `evaluate - type is survey and no params - return action survey`() {
        val jsonMessageAction = JsonMessageAction(
            type = "survey",
            value = "http://example.com",
    ...
    @Test
    fun `evaluate - type is survey but unknown params - return null`() {
        val jsonMessageAction = JsonMessageAction(
            type = "survey",
            value = "value",
    ...
    @Test
    fun `evaluate - query params in payload - return action survey with query params`() = runTest {
    ...
    @Test
    fun `evaluate - type is not survey - return null`() {
        val jsonMessageAction = JsonMessageAction(
            type = "notSurvey",
            value = "value",
