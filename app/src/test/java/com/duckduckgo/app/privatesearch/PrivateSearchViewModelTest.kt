...
internal class PrivateSearchViewModelTest {
    ...
    @Test
    fun `onAutocompleteSettingChanged - data store updated`() {
    ...
    @Test
    fun `onPrivateSearchMoreSearchSettingsClicked - command launch customize search webpage and pixel sent`() = runTest {
