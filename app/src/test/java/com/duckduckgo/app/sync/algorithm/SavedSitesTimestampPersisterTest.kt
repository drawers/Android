...
class SavedSitesTimestampPersisterTest {
    ...
    @Test
    fun `processBookmark - bookmark modified after - bookmark is replaced`() {
        val bookmark = Bookmark("bookmark1", "title", "www.example.com", "folder2", threeHoursAgo)
    ...
    @Test
    fun `processBookmark - remote bookmark modified before - not replaced`() {
    ...
    @Test
    fun `processBookmark - bookmark deleted - bookmark is deleted`() {
        val bookmark = Bookmark("bookmark1", "title", "www.example.com", "folder2", threeHoursAgo)
        repository.insert(bookmark)
    ...
    @Test
    fun `processFavouritesFolder - state - favourites replaced`() {
