...
class SavedSitesDuplicateFinderTest {
    ...
    @Test
    fun `findBookmarkDuplicate - bookmark already exists with different ids and urls - duplicate is not found`() {
        val bookmark = Bookmark("bookmark1", "title", "www.example.com", "folder2", "timestamp")
    ...
    @Test
    fun `findBookmarkDuplicate - bookmark exists with different parent id - duplicate not found`() {
        val bookmark = Bookmark("bookmark1", "title", "www.example.com", "folder2", "timestamp")
    ...
    @Test
    fun `findBookmarkDuplicate - bookmark already exists with different parentId and ids - duplicate not found`() {
        val bookmark = Bookmark("bookmark1", "title", "www.example.com", "folder2", "timestamp")
    ...
    @Test
    fun `findBookmarkDuplicate - bookmark not present - duplicate is not found`() {
        val bookmark = Bookmark("bookmark1", "title", "www.example.com", "folder2", "timestamp")
    ...
    @Test
    fun `findFolderDuplicate - folder not present - duplicate not found`() {
    ...
    @Test
    fun `findFolderDuplicate - folder with same title and parentId - duplicate is found`() {
        val folder = BookmarkFolder("folder1", "Folder", SavedSitesNames.BOOKMARKS_ROOT, 0, 0, "timestamp")
