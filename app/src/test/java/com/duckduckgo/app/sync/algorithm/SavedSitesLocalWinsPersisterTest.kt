...
class SavedSitesLocalWinsPersisterTest {
    ...
    @Test
    fun `processBookmark - processing deleted bookmark not present locally - not inserted`() {
    ...
    @Test
    fun `processRemoteBookmark - processing remote bookmark present locally - not replaced`() {
        val bookmark = Bookmark("bookmark1", "title", "www.example.com", "folder2", twoHoursAgo)
    ...
    @Test
    fun `processBookmarkFolder - folder not replaced`() {
