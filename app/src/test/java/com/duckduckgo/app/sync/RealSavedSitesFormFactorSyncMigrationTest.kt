...
class RealSavedSitesFormFactorSyncMigrationTest {
    ...
    @Test
    fun `onFormFactorFavouritesDisabled - copy native favorites in root`() = runTest {
    ...
    @Test
    fun `onFormFactorFavouritesDisabled - display mode native`() {
        savedSiteSettingsRepository.favoritesDisplayMode = FavoritesDisplayMode.NATIVE
    ...
    @Test
    fun `onFormFactorFavouritesDisabled - only favorites root folder exists`() {
