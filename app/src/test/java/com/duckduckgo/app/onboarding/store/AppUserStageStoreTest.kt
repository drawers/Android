...
class AppUserStageStoreTest {
    ...
    @Test
    fun `getUserAppStage - get current stage - returns Dax Onboarding`() = runTest {
    ...
    @Test
    fun `stageCompleted - stage new completed - stage Dax onboarding returned`() = runTest {
    ...
    @Test
    fun `stageCompleted - stage Dax onboarding completed - established returned`() = runTest {
        givenCurrentStage(AppStage.DAX_ONBOARDING)
    ...
    @Test
    fun `stageCompleted - stage established completed - stage established returned`() = runTest {
