...
class WelcomePageViewModelTest {
    ...
    @Test
    fun `onPrimaryCtaClicked - should show dialog - emit show dialog`() = runTest {
    ...
    @Test
    fun `onDefaultBrowserSet - call dialog shown and finish`() = runTest {
    ...
    @Test
    fun `onDefaultBrowserNotSet - call dialog shown and finish`() = runTest {
