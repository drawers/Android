...
class OnboardingPageManagerTest {
    ...
    @Test
    fun `buildPageBlueprints - DDG is not default browser - expected onboarding pages are two`() {
    ...
    @Test
    fun `buildPageBlueprints - DDG is not default browser and should show browser dialog - expected onboarding pages are 1`() {
        configureDeviceSupportsDefaultBrowser()
        whenever(mockDefaultBrowserDetector.isDefaultBrowser()).thenReturn(false)
    ...
    @Test
    fun `buildPageBlueprints - DDG as default browser - single page onboarding`() {
        configureDeviceSupportsDefaultBrowser()
    ...
    @Test
    fun `buildPageBlueprints - DDG as default browser and should show browser dialog - single page onboarding`() {
        configureDeviceSupportsDefaultBrowser()
        whenever(mockDefaultBrowserDetector.isDefaultBrowser()).thenReturn(true)
        whenever(defaultRoleBrowserDialog.shouldShowDialog()).thenReturn(true)
