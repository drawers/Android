...
class AddWidgetCompatLauncherTest {
    ...
    @Test
    fun `launchAddWidget - automatic widget add not supported - delegate to legacy add widget launcher`() {
    ...
    @Test
    fun `whenAutomaticWidgetAddIsSupportedThenDelegateToAppWidgetManagerAddWidgetLauncher - delegate to add widget launcher`() {
