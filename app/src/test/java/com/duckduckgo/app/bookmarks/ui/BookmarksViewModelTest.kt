...
class BookmarksViewModelTest {
    ...
    @Test
    fun `onDeleteSaveSiteRequested - bookmark delete undo - repository not updated`() = runTest {
    ...
    @Test
    fun `onDeleteSavedSite - repository updated`() = runTest {
        testee.onDeleteSavedSiteRequested(bookmark)
    ...
    @Test
    fun `onDeleteSaveSiteRequested - undo - repository not updated`() = runTest {
    ...
    @Test
    fun `onDeleteRequested - confirm command`() {
        testee.onDeleteSavedSiteRequested(bookmark)
    ...
    @Test
    fun `onBookmarkFolderSelected - issue open bookmark folder command`() {
    ...
    @Test
    fun `fetchBookmarksAndFolders - state updated with collected bookmarks and folders`() = runTest {
    ...
    @Test
    fun `fetchEverything - update state with data`() = runTest {
    ...
    @Test
    fun `onBookmarkFolderAdded - repository inserted`() = runTest {
    ...
    @Test
    fun `onBookmarkFolderUpdated - repository updated`() = runTest {
    ...
    @Test
    fun `onDeleteBookmarkFolderRequested - undo - repository not updated`() = runTest {
    ...
    @Test
    fun `onDeleteBookmarkFolderConfirmed - when delete bookmark folder confirmed then issue confirm delete bookmark folder command`() = runTest {
        val parentFolder = BookmarkFolder("folder1", "Parent Folder", SavedSitesNames.BOOKMARKS_ROOT, 0, 0, "timestamp")
        val childFolder = BookmarkFolder("folder2", "Parent Folder", "folder1", 0, 0, "timestamp")
        val childBookmark = Bookmark("bookmark1", "title", "www.example.com", "folder2", "timestamp")
        val folderBranch = FolderBranch(listOf(childBookmark), listOf(parentFolder, childFolder))
    ...
    @Test
    fun `onBookmarkFoldersActivityResult - command observer open saved site - open saved site`() {
    ...
    @Test
    fun `updateBookmarks - update folder relation`() {
