...
class BookmarksMigrationTest {
    ...
    @Test
    fun `whenFavoritesExist - migration successful`() = runTest {
    ...
    @Test
    fun `whenBookmarksWithFoldersAndFavoritesExist - migration is successful`() = runTest {
        val totalFolder = 10
        val bookmarksPerFolder = 5
        createFoldersTree(totalFolder, bookmarksPerFolder)
    ...
    @Test
    fun `whenBookmarkAndFavoriteHaveSameUrlThenBookmarkAlsoMigratedAsFavorite - migration applied - bookmark and favorite migrated`() {
    ...
    @Test
    fun `whenBookmarkAndFavoriteHaveDifferentUrlThenBothAreMigrated - bookmarks and favorites migrated`() {
        bookmarksDao.insert(BookmarkEntity(1, "Bookmark1", "http://test.com", 0))
    ...
    @Test
    fun `whenNeedsFormFactorMigration - favorites copied into form factor favorite folder`() {
