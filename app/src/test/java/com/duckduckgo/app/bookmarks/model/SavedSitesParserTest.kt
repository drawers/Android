...
class SavedSitesParserTest {
    ...
    @Test
    fun `doesNotImportAnything - file not properly formatted - empty bookmarks`() = runTest {
    ...
    @Test
    fun `canImportFromFirefox - import from firefox successful - 17 bookmarks imported`() = runTest {
    ...
    @Test
    fun `canImportFromBrave - import successful - 12 bookmarks found`() = runTest {
    ...
    @Test
    fun `canImportFromChrome - import bookmarks from chrome - 12 bookmarks imported`() = runTest {
    ...
    @Test
    fun `canImportBookmarksFromDDGAndroid - bookmarks parsed`() = runTest {
    ...
    @Test
    fun `canImportBookmarksFromDDGMacOS - bookmarks parsed`() = runTest {
    ...
    @Test
    fun `canImportBookmarksAndFavoritesFromDDG - can import bookmarks and favorites from DDG`() = runTest {
