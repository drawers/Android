...
class BrokenSiteDataTest {
    ...
    @Test
    fun `whenSiteExists - data contains url`() {
    ...
    @Test
    fun `whenUrlParametersNotRemoved - url parameters removed is false`() {
        val site = buildSite(SITE_URL)
        val data = BrokenSiteData.fromSite(site, reportFlow = MENU)
    ...
    @Test
    fun `whenSiteHasBlockedTrackersThenBlockedTrackersExist - blocked trackers exist`() {
        val site = buildSite(SITE_URL)
    ...
    @Test
    fun `whenSiteHasSurrogatesThenSurrogatesExist - surrogates exist`() {
    ...
    @Test
    fun `whenSiteHasSameHostSurrogates - only unique surrogate included in data`() {
        val surrogate = SurrogateResponse("test.js", true, "surrogate.com/test.js", "", "")
