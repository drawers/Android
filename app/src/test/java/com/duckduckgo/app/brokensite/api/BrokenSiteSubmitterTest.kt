...
class BrokenSiteSubmitterTest {
    ...
    @Test
    fun `submitBrokenSiteFeedback - vpn enabled - report true`() = runTest {
    ...
    @Test
    fun `submitBrokenSiteFeedback - site in user allow list - protections are off`() {
        whenever(mockContentBlocking.isAnException(any())).thenReturn(false)
    ...
    @Test
    fun `submitBrokenSiteFeedback - site in content blocking - protections are off`() {
    ...
    @Test
    fun `submitBrokenSiteFeedback - content blocking disabled - protections are off`() {
    ...
    @Test
    fun `submitBrokenSiteFeedback - site allowed - protections are on`() {
        whenever(mockContentBlocking.isAnException(any())).thenReturn(false)
        whenever(mockUserAllowListRepository.isDomainInUserAllowList(any())).thenReturn(false)
        whenever(mockUnprotectedTemporary.isAnException(any())).thenReturn(false)
        val brokenSite = getBrokenSite()
    ...
    @Test
    fun `submitBrokenSiteFeedback - successfully submitted - param sent and setLastSentDay called`() = runTest {
    ...
    @Test
    fun `submitBrokenSiteFeedback - device is English - include login site`() {
        whenever(mockAppBuildConfig.deviceLocale).thenReturn(Locale.ENGLISH)
        whenever(mockContentBlocking.isAnException(any())).thenReturn(false)
        whenever(mockUserAllowListRepository.isDomainInUserAllowList(any())).thenReturn(false)
        whenever(mockUnprotectedTemporary.isAnException(any())).thenReturn(false)
    ...
    @Test
    fun `submitBrokenSiteFeedback - device is not English - do not include login site`() {
    ...
    @Test
    fun `submitBrokenSiteFeedback - reportFlow is null - do not include param`() {
        val brokenSite = getBrokenSite()
    ...
    @Test
    fun `submitBrokenSiteFeedback - privacy protections popup experiment params present - included in pixel`() = runTest {
