...
class BrokenSiteSubmitterTest {
    ...
    @Test
    fun `whenVpnDisabledReport - vpn disabled - false`() = runTest {
    ...
    @Test
    fun `whenVpnEnabledReport - report true - vpn on`() = runTest {
    ...
    @Test
    fun `whenSiteInContentBlockingDisabledThenProtectionsAreOff - site in content blocking disabled - protections are off`() {
    ...
    @Test
    fun `submitBrokenSiteFeedback - when successfully submitted then param sent and set last sent day is called for that domain`() = runTest {
    ...
    @Test
    fun `whenDeviceIsNotEnglish - do not include login site - does not contain login site`() {
    ...
    @Test
    fun `submitBrokenSiteFeedback - report flow menu - include param`() {
        val brokenSite = getBrokenSite()
