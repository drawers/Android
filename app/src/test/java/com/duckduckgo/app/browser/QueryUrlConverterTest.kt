...
class QueryUrlConverterTest {
    ...
    @Test
    fun `convertQueryToUrl - encoding query with symbols`() {
        val input = "test \"%-.<>\\^_`{|~"
    ...
    @Test
    fun `convertQueryToUrl - from user is url`() {
    ...
    @Test
    fun `convertQueryToUrl - from autocomplete and is not url - search query built`() {
        val input = "foo"
    ...
    @Test
    fun `convertQueryToUrl - contains major vertical - adds vertical to url`() {
        val input = "foo"
