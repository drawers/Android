...
class WebShareChooserTest {
    ...
    @Test
    fun `whenTitleEmptyAndUrlThenParseCorrectData - parse correct data`() {
        val data = JsCallbackData(
    ...
    @Test
    fun `whenTitleAndUrlAndText - parse correct data`() {
        val data = JsCallbackData(
    ...
    @Test
    fun `whenTitleAndTextNullThenParseCorrectData - parse correct data`() {
        val data = JsCallbackData(
    ...
    @Test
    fun `parseResult - is other then return data error`() {
        val data = JsCallbackData(
            params = JSONObject("""{"title":"Sample title", "text":"Test"}"""),
            featureName = "featureName",
            id = "id",
