...
class BrowserApplicationStateInfoTest {
    ...
    @Test
    fun `onActivityCreated - no interactions`() {
    ...
    @Test
    fun `whenAllActivitiesStopAndRestartThenNotifyAppOpen - notify app open`() {
        browserApplicationStateInfo.onActivityCreated(activity, null)
        browserApplicationStateInfo.onActivityCreated(activity, null)
    ...
    @Test
    fun `whenAllActivitiesAreDestroyedByBackPressAndRecreated - do not notify fresh app launch`() {
