...
class MajorWebViewVersionProviderTest {
    ...
    @Test
    fun `getMajorVersion - web view version non numeric values - major version only`() {
    ...
    @Test
    fun `getMajorVersion - web view version has no valid delimiter - unknown`() {
    ...
    @Test
    fun `getMajorVersion - web view version non numeric major - unknown`() {
    ...
    @Test
    fun `getMajorVersion - web view version starts with delimiter - return unknown major version`() {
        whenever(webViewVersionSource.get()).thenReturn(".91.1.12.1234.423")
