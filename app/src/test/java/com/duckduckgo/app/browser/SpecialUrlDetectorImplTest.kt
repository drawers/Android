...
class SpecialUrlDetectorImplTest {
    ...
    @Test
    fun `determineType - tel URL with dashes - telephone type detected`() {
    ...
    @Test
    fun `determineType - url is smsto - scheme removed`() {
    ...
    @Test
    fun `determineType - javascript scheme URL - full query retained`() {
