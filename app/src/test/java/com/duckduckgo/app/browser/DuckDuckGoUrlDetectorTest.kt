...
class DuckDuckGoUrlDetectorTest {
    ...
    @Test
    fun `isDuckDuckGoQueryUrl - non-DDG URL with query - query not detected`() {
    ...
    @Test
    fun `isDuckDuckGoVerticalUrl - DDG URL contains vertical - vertical URL detected`() {
    ...
    @Test
    fun `isDuckDuckGoStaticUrl - non DDG - static page not detected`() {
    ...
    @Test
    fun `isDuckDuckGoEmailUrl - url has no scheme and is from DuckDuckGo - returns false`() {
