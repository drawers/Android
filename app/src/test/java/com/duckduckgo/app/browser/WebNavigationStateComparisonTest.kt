...
class WebNavigationStateComparisonTest {
    ...
    @Test
    fun `compare - same original url and different current url with same host - returns url updated`() {
    ...
    @Test
    fun `compare - no original url and no current url - page cleared`() {
        val previousState = buildState("http://previous.com", "http://subdomain.previous.com")
    ...
    @Test
    fun `compare - previous contains original URL and current URL, latest contains no original URL and current URL - returns page cleared`() {
        val previousState = buildState("http://previous.com", "http://subdomain.previous.com")
