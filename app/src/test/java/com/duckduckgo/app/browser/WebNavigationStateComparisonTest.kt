...
class WebNavigationStateComparisonTest {
    ...
    @Test
    fun `compare - previous state is null and latest contains original url - new page without title`() {
        val previousState = null
    ...
    @Test
    fun `compare - previous and current states different - new page`() {
    ...
    @Test
    fun `compare - previous contains original url and current url and latest contains same original url and different current url domain - new page`() {
    ...
    @Test
    fun `compare - prev contains original url and current url with same host - returns url updated`() {
    ...
    @Test
    fun `compare - previous contains original url and current url - returns other`() {
        val previousState = buildState("http://previous.com", "http://subdomain.previous.com")
