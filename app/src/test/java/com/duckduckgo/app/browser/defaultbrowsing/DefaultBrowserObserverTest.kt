...
class DefaultBrowserObserverTest {
    ...
    @Test
    fun `onResume - DDG set as default browser - fire set pixel`() {
    ...
    @Test
    fun `onResume - DDG is not default browser and was not before - do not fire set pixel`() {
    ...
    @Test
    fun `onResume - DDG is default browser - do not fire set pixel`() {
        whenever(mockDefaultBrowserDetector.isDefaultBrowser()).thenReturn(true)
    ...
    @Test
    fun `onResume - DDG was default browser but now is not - fire unset pixel`() {
        whenever(mockDefaultBrowserDetector.isDefaultBrowser()).thenReturn(false)
        whenever(mockAppInstallStore.defaultBrowser).thenReturn(true)
