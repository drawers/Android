...
class EmptyNavigationStateTest {
    ...
    @Test
    fun `EmptyNavigationState - empty navigation state - browser properties are the same`() {
    ...
    @Test
    fun `EmptyNavigationState - from navigation state - navigation properties are cleared`() {
