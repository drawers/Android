...
class PixelReQueryInterceptorTest {
    ...
    @Test
    fun `intercept - rq0 pixel sent - remove device and form factor`() {
        assertEquals(
    ...
    @Test
    fun `intercept - rq1 pixel sent - remove device and form factor`() {
        assertEquals(
    ...
    @Test
    fun `intercept - other pixel phone and tablet urls - do not modify`() {
        assertEquals(
