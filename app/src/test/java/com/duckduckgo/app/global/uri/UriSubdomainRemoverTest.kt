...
class UriSubdomainRemoverTest {
    ...
    @Test
    fun `removeSubdomain - five available then four returned`() {
    ...
    @Test
    fun `removeSubdomain - recent TLD exists - returns null`() {
    ...
    @Test
    fun `removeSubdomain - uri ip address - returns null`() {
