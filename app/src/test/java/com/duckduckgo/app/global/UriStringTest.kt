...
class UriStringTest {
    ...
    @Test
    fun `isWebUrl - invalid host contains space - false`() {
    ...
    @Test
    fun `isWebUrl - incomplete https scheme missing both slashes - false`() {
        assertFalse(isWebUrl("https:"))
    }
    ...
    @Test
    fun `isWebUrl - valid path missing scheme localhost - true`() {
    ...
    @Test
    fun `isWebUrl - invalid path with space and localhost - false`() {
    ...
    @Test
    fun `isWebUrl - invalid path with space and missing scheme localhost - false`() {
        assertFalse(isWebUrl("localhost/pa th"))
    }

    @Test
    fun `isWebUrl - valid path with encoded space - true`() {
    ...
    @Test
    fun `isWebUrl - string with dot suffix - is false`() {
        assertFalse(isWebUrl("randomtext."))
    }

    @Test
    fun `isWebUrl - given number - false`() {
    ...
    @Test
    fun `isWebUrl - valid FTP scheme but not HTTP - false`() {
