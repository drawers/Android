...
class UriExtensionTest {
    ...
    @Test
    fun `baseHost - uri contains invalid host - is null`() {
        val url = "about:blank"
    ...
    @Test
    fun `isHttps - malformed URI - is false`() {
    ...
    @Test
    fun `faviconLocation - http request - favicon location is http`() {
        val favicon = "http://example.com".toUri().faviconLocation()
        assertTrue(favicon!!.isHttp)
    }

    @Test
    fun `faviconLocation - https request - location is https`() {
