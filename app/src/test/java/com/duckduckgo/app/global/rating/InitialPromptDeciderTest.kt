...
class InitialPromptDeciderTest {
    ...
    @Test
    fun `shouldShowPrompt - user has not seen prompt before and used app exact enough days`() = runTest {
    ...
    @Test
    fun `shouldShowPrompt - user has not seen prompt before and used app more than enough days`() = runTest {
