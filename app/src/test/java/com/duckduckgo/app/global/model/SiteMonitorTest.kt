...
class SiteMonitorTest {
    ...
    @Test
    fun `SiteMonitor - url is malformed - https status is none`() {
        val testee = SiteMonitor(
    ...
    @Test
    fun `privacyProtection - site in user allow list - unprotected`() {
    ...
    @Test
    fun `privacyProtection - site is http - unprotected`() {
    ...
    @Test
    fun `privacyProtection - site not exception or http and full details not available - return unknown`() {
    ...
    @Test
    fun `updatePrivacyData - site is major network - privacy shield is protected`() {
        val testee = givenASiteMonitor(url = httpsDocument)
    ...
    @Test
    fun `updatePrivacyData - privacy issues not found - privacy shield is protected`() {
        val testee = givenASiteMonitor(url = httpsDocument)
    ...
    @Test
    fun `privacyProtection - user bypassed SSL certificate - unprotected`() {
        val testee = givenASiteMonitor(url = document)
