...
class SiteMonitorTest {
    ...
    @Test
    fun `whenUrlIsHttpsWithHttpResourcesThenHttpsStatusIsMixed - https status mixed`() {
        val testee = SiteMonitor(
            url = httpsDocument,
            title = null,
            userAllowListRepository = mockAllowListRepository,
    ...
    @Test
    fun `when SiteMonitor created - tracker count is zero`() {
        val testee = SiteMonitor(
            url = document,
            title = null,
            userAllowListRepository = mockAllowListRepository,
    ...
    @Test
    fun `trackerDetected - trackers blocked or allowed by user are detected - tracker count incremented`() {
        val testee = SiteMonitor(
            url = document,
            title = null,
            userAllowListRepository = mockAllowListRepository,
    ...
    @Test
    fun `trackerDetected - no trackers allowed by user - all trackers blocked is true`() {
        val testee = SiteMonitor(
            url = document,
            title = null,
            userAllowListRepository = mockAllowListRepository,
    ...
    @Test
    fun `trackerDetected - duplicate major network detected - major network count still one`() {
        val testee = SiteMonitor(
            url = document,
            title = null,
            userAllowListRepository = mockAllowListRepository,
    ...
    @Test
    fun `whenSiteCreated - site upgraded https is false`() {
        val testee = SiteMonitor(
            url = document,
            title = null,
            userAllowListRepository = mockAllowListRepository,
    ...
    @Test
    fun `whenSiteCreated - surrogates size is zero`() {
        val testee = SiteMonitor(
            url = document,
            title = null,
            userAllowListRepository = mockAllowListRepository,
    ...
    @Test
    fun `whenSpecialDomainsAreLoadedThenSpecialDomainsLoadedCountIsIncremented - special domains loaded count incremented`() {
        val testee = SiteMonitor(
            url = document,
            title = null,
            userAllowListRepository = mockAllowListRepository,
    ...
    @Test
    fun `isDomainInUserAllowList - site belongs to user allow list - privacy shield unprotected`() {
    ...
    @Test
    fun `givenASiteMonitor - site not exception or http but full details not available - return unknown`() {
