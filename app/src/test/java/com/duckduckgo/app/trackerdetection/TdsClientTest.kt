...
class TdsClientTest {
    ...
    @Test
    fun `matches - same domain as tracker entry and default action ignore - is false`() {
    ...
    @Test
    fun `matches - rule with exceptions and type matches exception - false`() {
    ...
    @Test
    fun `matches - rule with surrogate - true irrespective of action except ignore`() {
    ...
    @Test
    fun `test - url matches rule with type exception and domains is null - matches is false`() {
        test(
            mapResult = image,
    ...
    @Test
    fun `test - url matches rule with type exception and domains empty - matches is false`() {
        test(
            mapResult = image,
    ...
    @Test
    fun `test - url matches rule with domain exception and types is null - matches is false`() {
        test(
            mapResult = image,
    ...
    @Test
    fun `test - url matches rule with domain exception and types empty - matches is false`() {
        test(
            mapResult = image,
            rule = Rule(
                ruleString,
    ...
    @Test
    fun `test - url matches rule with domain and type exception - matches is false`() {
        test(
            mapResult = image,
    ...
    @Test
    fun `matches - blocked tracker with matching exception and empty option domain - false`() {
    ...
    @Test
    fun `test - blocked tracker with matching exception and empty option type - matches false`() {
    ...
    @Test
    fun `matches - blocked tracker with matching exception and option domain but not option type - true`() {
    ...
    @Test
    fun `matches - blocked tracker with matching exception but not option domain and type - true`() {
    ...
    @Test
    fun `test - options don't match domain or type - matches true`() {
    ...
    @Test
    fun `matches - url matches rule with surrogate - surrogate script id returned`() {
