...
class TdsDomainEntityJsonTest {
    ...
    @Test
    fun `jsonToDomainEntities - valid format - domain entities created`() {
    ...
    @Test
    fun `jsonToDomainEntities - valid format - converted correctly`() {
        val json = loadText(javaClass.classLoader!!, "json/tds_domain_entities.json")
        val domains = jsonAdapter.fromJson(json)!!.jsonToDomainEntities()
    ...
    @Test
    fun `jsonToDomainEntities - value is null - domain entities not created`() {
