...
class TdsTrackerJsonTest {
    ...
    @Test
    fun `jsonToTrackers - valid format - trackers are created`() {
    ...
    @Test
    fun `jsonToTrackers - valid format - basic elements converted correctly`() {
        val json = loadText(javaClass.classLoader!!, "json/tds_trackers.json")
        val trackers = jsonAdapter.fromJson(json)!!.jsonToTrackers()
    ...
    @Test
    fun `jsonToTrackers - invalid default action - tracker converted correctly`() {
    ...
    @Test
    fun `jsonToTrackers - tracker missing default action - tracker not created`() {
