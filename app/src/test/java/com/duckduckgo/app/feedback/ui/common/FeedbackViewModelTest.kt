...
class FeedbackViewModelTest {
    ...
    @Test
    fun `whenCanRateAppAndUserNavigatesBackFromPositiveInitialFragment - fragment state initial fragment`() {
        configureRatingCanBeGiven()
        testee.userSelectedPositiveFeedback()
    ...
    @Test
    fun `whenCannotRateAppAndUserNavigatesBackFromPositiveInitialFragment - fragment state initial fragment`() {
        configureRatingCannotBeGiven()
        testee.userSelectedPositiveFeedback()
        testee.onBackPressed()
    ...
    @Test
    fun `userWantsToCancel - exit command issued - feedback not submitted`() {
    ...
    @Test
    fun `onBackPressed - fragment state initial - initial fragment`() {
        testee.userSelectedNegativeFeedback()
        testee.onBackPressed()
        assertTrue(updateViewCommand is InitialAppEnjoymentClarifier)
        verifyBackwardsNavigation(updateViewCommand)
    ...
    @Test
    fun `userSelectsMainNegativeReasonMissingBrowserFeatures - fragment state is sub reason selection`() {
    ...
    @Test
    fun `userSelectsMainNegativeReason - not enough customizations - fragment state sub reason selection`() {
    ...
    @Test
    fun `userSelectsMainNegativeReason - fragment state sub reason selection`() {
    ...
    @Test
    fun `userSelectsMainNegativeReasonAppIsSlowOrBuggy - fragment state is sub reason selection`() {
    ...
    @Test
    fun `onBackPressed - fragment state is main reason selection`() {
        testee.userSelectedNegativeFeedbackMainReason(OTHER)
        testee.onBackPressed()
        assertTrue(updateViewCommand is NegativeFeedbackMainReason)
        verifyBackwardsNavigation(updateViewCommand)
    ...
    @Test
    fun `onBackPressed - fragment state is sub reason selection - negative feedback sub reason`() {
        testee.userSelectedNegativeFeedbackMainReason(MISSING_BROWSING_FEATURES)
        testee.userSelectedSubReasonMissingBrowserFeatures(MISSING_BROWSING_FEATURES, TAB_MANAGEMENT)
        testee.onBackPressed()
        assertTrue(updateViewCommand is NegativeFeedbackSubReason)
