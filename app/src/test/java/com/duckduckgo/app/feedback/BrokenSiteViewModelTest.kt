...
class BrokenSiteViewModelTest {
    ...
    @Test
    fun `whenCanSubmitBrokenSiteAndUrlNotNullAndSubmitPressedThenReportAndPixelSubmitted - set initial broken site and submit pressed - report and pixel submitted`() {
    ...
    @Test
    fun `setInitialBrokenSite - do not submit - does not fire pixel and send feedback`() {
        val nullUrl = ""
        testee.setInitialBrokenSite(
            url = nullUrl,
            blockedTrackers = "",
    ...
    @Test
    fun `setInitialBrokenSite - reportUrl and pixel submitted`() {
    ...
    @Test
    fun `setInitialBrokenSite - can submit broken site and url not null and submit pressed - report and pixel submitted with params`() {
        whenever(mockAmpLinks.lastAmpLinkInfo).thenReturn(AmpLinkInfo(trackingUrl, url))
    ...
    @Test
    fun `setInitialBrokenSite - isDesktopMode true - send desktop parameter`() {
        testee.setInitialBrokenSite(
            url = url,
            blockedTrackers = "",
            surrogates = "",
    ...
    @Test
    fun `whenIsDesktopModeFalseThenSendMobileParameter - send mobile parameter`() {
        testee.setInitialBrokenSite(
            url = url,
            blockedTrackers = "",
            surrogates = "",
    ...
    @Test
    fun `whenGetBrokenSiteThenReturnCorrectCategory - set initial broken site - correct category`() {
    ...
    @Test
    fun `whenCategoryLoginsThenUseLoginSite - set initial broken site - submit pressed`() {
    ...
    @Test
    fun `whenCategoryIsNotLoginsThenDoNotUseLoginSite - do not use login site`() {
    ...
    @Test
    fun `whenUrlIsInUnprotectedTemporaryExceptionsThenSiteProtectionsAreDisabled - view state disabled by remote config`() {
        whenever(mockFeatureToggle.isFeatureEnabled(PrivacyFeatureName.ContentBlockingFeatureName.value))
            .thenReturn(true)
    ...
    @Test
    fun `whenUrlIsInContentBlockingExceptionsThenSiteProtectionsAreDisabled - view state protections disabled`() {
        whenever(mockFeatureToggle.isFeatureEnabled(PrivacyFeatureName.ContentBlockingFeatureName.value))
            .thenReturn(true)
    ...
    @Test
    fun `whenUrlIsInUserAllowlistThenSiteProtectionsAreDisabled - view state protections disabled`() {
        whenever(mockFeatureToggle.isFeatureEnabled(PrivacyFeatureName.ContentBlockingFeatureName.value))
            .thenReturn(true)
    ...
    @Test
    fun `whenUrlIsNotInUserAllowlistThenSiteProtectionsAreEnabled - view state enabled`() {
        whenever(mockFeatureToggle.isFeatureEnabled(PrivacyFeatureName.ContentBlockingFeatureName.value))
            .thenReturn(true)
