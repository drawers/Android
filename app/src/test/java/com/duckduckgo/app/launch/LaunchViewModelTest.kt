...
class LaunchViewModelTest {
    ...
    @Test
    fun `determineViewToShow - onboarding and referrer data times out - command is onboarding`() = runTest {
        testee = LaunchViewModel(
            userStageStore,
    ...
    @Test
    fun `determineViewToShow - onboarding not shown and referrer data returns quickly - command is home`() = runTest {
