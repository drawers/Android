...
class LaunchViewModelTest {
    ...
    @Test
    fun `determineViewToShow - onboarding and referrer data returns quickly - command is onboarding`() = runTest {
    ...
    @Test
    fun `determineViewToShow - onboarding with delayed referrer data - command is onboarding`() = runTest {
        testee = LaunchViewModel(
            userStageStore,
    ...
    @Test
    fun `determineViewToShow - onboarding referrer data times out - command is onboarding`() = runTest {
        testee = LaunchViewModel(
            userStageStore,
    ...
    @Test
    fun `determineViewToShow - onboarding with quick referrer data - command is home`() = runTest {
    ...
    @Test
    fun `determineViewToShow - onboarding with delayed referrer data - command is home`() = runTest {
        testee = LaunchViewModel(
            userStageStore,
            StubAppReferrerFoundStateListener("xx", mockDelayMs = 1_000),
            mockExtendedOnboardingExperimentVariantManager,
    ...
    @Test
    fun `determineViewToShow - onboarding and referrer data times out - command is home`() = runTest {
        testee = LaunchViewModel(
            userStageStore,
            StubAppReferrerFoundStateListener("xx", mockDelayMs = Long.MAX_VALUE),
            mockExtendedOnboardingExperimentVariantManager,
