...
class AndroidNotificationSchedulerTest {
    ...
    @Test
    fun `scheduleNextNotification - privacy notification clear data can show - is scheduled`() = runTest {
    ...
    @Test
    fun `scheduleNextNotification - privacy notification can show but clear data cannot - is scheduled`() = runTest {
        whenever(mockPrivacyNotification.canShow()).thenReturn(true)
    ...
    @Test
    fun `scheduleNextNotification - privacy and clear notifications cannot show - no notification scheduled`() = runTest {
        whenever(mockPrivacyNotification.canShow()).thenReturn(false)
        whenever(mockClearNotification.canShow()).thenReturn(false)
