...
class AccessibilitySettingsViewModelTest {
    ...
    @Test
    fun `viewModelCreated - default viewState emitted`() = runTest {
    ...
    @Test
    fun `start - viewState emitted`() = runTest {
        val viewState = AccessibilitySettingsViewModel.ViewState(
    ...
    @Test
    fun `onForceZoomChanged - force zoom enabled - viewState emitted`() = runTest {
    ...
    @Test
    fun `onForceZoomChanged - force zoom enabled - settings updated`() = runTest {
        whenever(accessibilitySettings.forceZoom).thenReturn(true)
    ...
    @Test
    fun `onSystemFontSizeChanged - override system font size enabled - viewState emitted`() = runTest {
        val viewState = defaultViewState()
        whenever(accessibilitySettings.overrideSystemFontSize).thenReturn(true)
    ...
    @Test
    fun `onSystemFontSizeChanged - override system font size enabled - settings updated`() = runTest {
        whenever(accessibilitySettings.overrideSystemFontSize).thenReturn(true)
    ...
    @Test
    fun `onFontSizeChanged - viewState emitted`() = runTest {
        val viewState = defaultViewState()
        whenever(accessibilitySettings.appFontSize).thenReturn(150f)
    ...
    @Test
    fun `onVoiceSearchChanged - voice search enabled - viewState emitted`() = runTest {
        val viewState = defaultViewState()
        whenever(voiceSearchAvailability.isVoiceSearchAvailable).thenReturn(true)
    ...
    @Test
    fun `onVoiceSearchChanged - voice search enabled - settings updated`() = runTest {
        testee.onVoiceSearchChanged(true)
        verify(voiceSearchRepository).setVoiceSearchUserEnabled(true)
    }

    @Test
    fun `onVoiceSearchChanged - voice search disabled - settings updated`() = runTest {
        testee.onVoiceSearchChanged(false)
        verify(voiceSearchRepository).setVoiceSearchUserEnabled(false)
    }

    @Test
    fun `onVoiceSearchChanged - voice search enabled - fire pixel`() = runTest {
        testee.onVoiceSearchChanged(true)
