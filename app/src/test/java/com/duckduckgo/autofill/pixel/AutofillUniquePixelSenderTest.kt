...
class AutofillUniquePixelSenderTest {
    ...
    @Test
    fun `sendCapabilitiesPixel - sharedPreferences records pixel was sent before`() = runTest {
    ...
    @Test
    fun `sendCapabilitiesPixel - device auth enabled but secure storage not available - send correct pixel`() {
