...
class CookiesFeaturePluginTest {
    ...
    @Test
    fun `store - feature name does not match cookies - return false`() {
    ...
    @Test
    fun `store - feature name matches cookies - return true`() {
    ...
    @Test
    fun `store - feature name matches cookies and has min supported version - store min supported version`() {
    ...
    @Test
    fun `store - feature name matches cookies - update all existing values`() {
        val jsonString = FileUtilities.loadText(CookiesFeaturePluginTest::class.java.classLoader!!, "json/cookies.json")
