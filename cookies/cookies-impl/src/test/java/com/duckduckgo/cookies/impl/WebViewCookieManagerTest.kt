...
class WebViewCookieManagerTest {
    ...
    @Test
    fun `removeExternalCookies - cookies removed - internal cookies recreated`() = runTest {
    ...
    @Test
    fun `removeExternalCookies - cookies stored - flush before and after interacting with cookie manager`() = runTest {
        givenCookieManagerWithCookies(ddgCookie, externalHostCookie)
