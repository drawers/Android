...
internal class AppProtectionStatusViewStateMapperTest {
    ...
    @Test
    fun `mapFromSite - site in user allow list - allow listed is true`() {
    ...
    @Test
    fun `mapFromSite - site is unprotected temporary - true`() {
    ...
    @Test
    fun `mapFromSite - content blocking enabled - view state protections enabled`() {
        val viewState = testee.mapFromSite(site())
