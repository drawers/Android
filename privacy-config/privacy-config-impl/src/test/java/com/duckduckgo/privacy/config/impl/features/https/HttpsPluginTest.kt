...
class HttpsPluginTest {
    ...
    @Test
    fun `store - feature name does not match https - returns false`() {
    ...
    @Test
    fun `store - feature name matches https - returns true`() {
    ...
    @Test
    fun `store - feature name matches https and has min supported version - stores min supported version`() {
    ...
    @Test
    fun `store - https feature name matches - update all existing exceptions`() {
        val jsonString = FileUtilities.loadText(javaClass.classLoader!!, "json/https.json")
