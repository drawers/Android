...
class TrackerAllowlistPluginTest {
    ...
    @Test
    fun `store - feature name does not match tracker allowlist - returns false`() {
    ...
    @Test
    fun `store - feature name matches tracker allowlist - returns true`() {
    ...
    @Test
    fun `whenFeatureNameMatchesTrackerAllowlist - update all existing exceptions`() {
        val jsonString = FileUtilities.loadText(javaClass.classLoader!!, "json/tracker_allowlist.json")
