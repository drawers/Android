...
class TrackingParametersPluginTest {
    ...
    @Test
    fun `store - feature name does not match tracking parameters - return false`() {
    ...
    @Test
    fun `store - feature name matches tracking parameters - return true`() {
    ...
    @Test
    fun `store - feature name matches tracking parameters - update all existing values`() {
        val jsonString = FileUtilities.loadText(TrackingParametersPluginTest::class.java.classLoader!!, "json/tracking_parameters.json")
