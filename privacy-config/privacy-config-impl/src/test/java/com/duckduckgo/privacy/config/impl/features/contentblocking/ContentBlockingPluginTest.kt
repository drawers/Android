...
class ContentBlockingPluginTest {
    ...
    @Test
    fun `store - feature name does not match content blocking - return false`() {
    ...
    @Test
    fun `store - feature name matches content blocking - return true`() {
    ...
    @Test
    fun `store - feature name matches content blocking and has min supported version - store min supported version`() {
