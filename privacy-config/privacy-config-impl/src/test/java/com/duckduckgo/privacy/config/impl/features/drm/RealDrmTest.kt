...
class RealDrmTest {
    ...
    @Test
    fun `isDrmAllowedForUrl - feature disabled - false`() {
        val url = "https://open.spotify.com"
    ...
    @Test
    fun `isDrmAllowedForUrl - is in user allow list - true`() {
        giveFeatureIsEnabled()
        givenUrlIsNotInExceptionList()
    ...
    @Test
    fun `isDrmAllowedForUrl - is in unprotected temporary - true returned`() {
        giveFeatureIsEnabled()
        givenUrlIsNotInExceptionList()
