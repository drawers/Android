...
class DrmPluginTest {
    ...
    @Test
    fun `store - feature name does not match EME - return false`() {
    ...
    @Test
    fun `store - feature name matches EME - return true`() {
    ...
    @Test
    fun `store - feature name matches EME - update all existing exceptions`() {
        val jsonString = FileUtilities.loadText(javaClass.classLoader!!, "json/drm.json")
