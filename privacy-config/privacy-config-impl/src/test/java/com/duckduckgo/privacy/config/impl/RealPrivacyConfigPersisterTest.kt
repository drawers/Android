...
class RealPrivacyConfigPersisterTest {
    ...
    @Test
    fun `signature - different plugin points - different signatures`() {
    ...
    @Test
    fun `persistPrivacyConfig - plugin matches feature name - store called`() =
        runTest {
            testee.persistPrivacyConfig(getJsonPrivacyConfig())
    ...
    @Test
    fun `persistPrivacyConfig - version is lower than previous - do nothing`() =
        runTest {
    ...
    @Test
    fun `persistPrivacyConfig - version lower than previous and different plugins - store new config`() =
        runTest {
    ...
    @Test
    fun `persistPrivacyConfig - version equals previous - do nothing`() =
        runTest {
    ...
    @Test
    fun `persistPrivacyConfig - version equals previous and different plugins - update config`() =
        runTest {
            sharedPreferences.edit().putInt("plugin_signature", 0)
            privacyRepository.insert(PrivacyConfig(version = 2, readme = "readme", eTag = "eTag", timestamp = "2023-01-02"))
    ...
    @Test
    fun `persistPrivacyConfig - version is higher than previous one - store new config`() =
        runTest {
    ...
    @Test
    fun `persistPrivacyConfig - version is higher and different plugins - store new config`() =
        runTest {
            sharedPreferences.edit().putInt("plugin_signature", 0)
            privacyRepository.insert(PrivacyConfig(version = 1, readme = "readme", eTag = "eTag", timestamp = "2023-01-02"))
