...
class AdClickFeatureTogglesPluginTest {
    ...
    @Test
    fun `isEnabled - ad click feature enabled - returns true`() =
        runTest {
    ...
    @Test
    fun `isEnabled - ad click feature does not exist - return default value`() =
        runTest {
    ...
    @Test
    fun `isEnabled - ad click feature enabled and app version greater than min supported - returns true`() =
        runTest {
            givenAdCLickFeatureIsEnabled()
