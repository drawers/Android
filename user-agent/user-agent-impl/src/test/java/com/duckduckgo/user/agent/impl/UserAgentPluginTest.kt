...
class UserAgentPluginTest {
    ...
    @Test
    fun `store - feature name does not match user agent - return false`() {
    ...
    @Test
    fun `store - feature name matches user agent - return true`() {
    ...
    @Test
    fun `store - feature name matches user agent and has min supported version - store min supported version`() {
