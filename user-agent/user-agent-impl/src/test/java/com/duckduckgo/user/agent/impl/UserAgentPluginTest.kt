...
class UserAgentPluginTest {
    ...
    @Test
    fun `whenFeatureNameMatchesUserAgentAndHasMinSupportedVersion - store min supported version`() {
    ...
    @Test
    fun `whenFeatureNameMatchesUserAgentThenUpdateAllExistingExceptions - store - update all existing exceptions`() {
        val jsonString = FileUtilities.loadText(javaClass.classLoader!!, "json/useragent.json")
