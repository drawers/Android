...
class GlobalUncaughtExceptionHandlerTest {
    ...
    @Test
    fun `uncaughtException - not in ignore list - default exception handler called`() = runTest {
    ...
    @Test
    fun `uncaughtException - exception is interruptedException - crash not recorded`() = runTest {
