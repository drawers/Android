...
class SavedSitesManagerTest {
    ...
    @Test
    fun `import - bookmarks import succeeds - pixel sent`() = runTest {
    ...
    @Test
    fun `import - favorites succeed - pixel sent`() = runTest {
        val someUri = Uri.parse("")
    ...
    @Test
    fun `import - saved sites import fails - pixel sent`() = runTest {
        val someUri = Uri.parse("")
    ...
    @Test
    fun `export - saved sites export succeeds - pixel sent`() = runTest {
        val someUri = Uri.parse("")
    ...
    @Test
    fun `export - saved sites export fails - pixel sent`() = runTest {
        val someUri = Uri.parse("")
